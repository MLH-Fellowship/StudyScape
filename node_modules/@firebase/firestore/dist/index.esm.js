...
import { XhrIo as d, EventType as v, ErrorCode as y, createWebChannelTransport as g, WebChannel as m } from "@firebase/webchannel-wrapper";
 ...
 */ function T(t) {
    ...
    if (E.logLevel <= s.DEBUG) {
        var i = e.map(S);
        E.debug.apply(E, r([ "Firestore (7.23.0): " + t ], i));
    }
}
...
function N(t) {
    ...
    if (E.logLevel <= s.ERROR) {
        var i = e.map(S);
        E.error.apply(E, r([ "Firestore (7.23.0): " + t ], i));
    }
}
...
function A(t) {
    ...
    if (E.logLevel <= s.WARN) {
        var i = e.map(S);
        E.warn.apply(E, r([ "Firestore (7.23.0): " + t ], i));
    }
}
 ...
 */ function D(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (7.23.0) INTERNAL ASSERTION FAILED: " + t;
...
}(L), P = /^[_a-zA-Z][_a-zA-Z0-9]*$/, C = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n.prototype.o = function(t, e, r) {
...
function Tt(t) {
    ...
    if (null === e.Z) {
        ...
        n += br(e.startAt)), e.endAt && (n += "|ub:", n += br(e.endAt)), e.Z = n;
    }
    return e.Z;
}
 ...
 */ var St, Dt, kt = /** @class */ function() {
     ...
     */ , s) {
        void 0 === i && (i = mt.min()), void 0 === o && (o = mt.min()), void 0 === s && (s = ct.B), 
...
var Rt = /** @class */ function() {
    function t(t, e) {
        this.i = t, this.root = e || Ut.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.rt = function(e, n) {
        return new t(this.i, this.root.rt(e, n, this.i).copy(null, null, Ut.ot, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.i, this.root.remove(e, this.i).copy(null, null, Ut.ot, null, null));
    }, 
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
Ut.EMPTY = null, Ut.RED = !0, Ut.ot = !1, 
// end LLRBEmptyNode
Ut.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var Gt = new Rt(M.i), zt = new Pt(M.i);
 ...
 */ var Yt = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.Mt = Bt(), this.Ot = new Rt(this.i)
        /**
    ...
    return t.Kt = function(e, n, r, i) {
        ...
        if (!(this.fromCache === t.fromCache && this.Wt === t.Wt && this.Qt.isEqual(t.Qt) && or(this.query, t.query) && this.docs.isEqual(t.docs) && this.Ut.isEqual(t.Ut))) return !1;
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Xt.Xt(e, n)), new t(mt.min(), r, Qt(), Ft(), Wt());
    }, t;
}(), Xt = /** @class */ function() {
    function t(
    /**
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    return t.prototype.pe = function(t) {
        for (var e = 0, n = t.se; e < n.length; e++) {
            var r = n[e];
            t.ie instanceof Gn ? this.be(r, t.ie) : t.ie instanceof zn && this.ve(r, t.key, t.ie);
        }
    ...
    t.prototype.Me = function(t) {
        ...
        this.Pe.forEach((function(r, i) {
            ...
            if (o) {
                if (r.Zt && At(o.target)) {
                    ...
                    null !== e.ge.get(s) || e.Oe(i, s) || e.ve(i, s, new zn(s, t));
                }
        ...
        return this.ge = Ft(), this.ye = ie(), this.Ve = new Pt(st), i;
    }, 
    /**
    ...
    t.prototype.Ee = function(t) {
        ...
        var e = this.ye.get(t);
        return e || (e = new Pt(st), this.ye = this.ye.rt(t, e)), e;
    }, 
    /**
 ...
 */ function ae(t) {
    var e = ge(t.mapValue.fields.__local_write_time__.timestampValue);
    ...
    switch (n) {
      ...
      case 3 /* TimestampValue */ :
        return function(t, e) {
            ...
            var n = ge(t.timestampValue), r = ge(e.timestampValue);
...
function de(t, e) {
    ...
    var n = ge(t), r = ge(e), i = st(n.seconds, r.seconds);
...
function ye(t) {
    ...
    M.C(n).toString()) : "geoPointValue" in t ? "geo(" + (e = t.geoPointValue).latitude + "," + e.longitude + ")" : "arrayValue" in t ? function(t) {
...
function je(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? U.g() : Ge(e);
}

function Be(t) {
    return new U([ "projects", t.U.projectId, "databases", t.U.database ]).R();
}
...
function Ke(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? _n.updateTime(Ue(t.updateTime)) : void 0 !== t.exists ? _n.exists(t.exists) : _n.Ge();
    }(e.currentDocument) : _n.Ge();
    if (e.update) {
        e.update.name;
        var r = Fe(t, e.update.name), i = new Fn({
            mapValue: {
    ...
    if (e.transform) {
        var u = Fe(t, e.transform.document), a = e.transform.fieldTransforms.map((function(e) {
            return function(t, e) {
                var n = null;
                if ("setToServerValue" in e) k("REQUEST_TIME" === e.setToServerValue), n = new ln; else if ("appendMissingElements" in e) {
                    ...
                    n = new vn(i);
                } else "increment" in e ? n = new gn(t, e.increment) : D();
                var o = C.S(e.fieldPath);
                return new In(o, n);
            }(t, e);
        }));
        return k(!0 === n.exists), new Ln(u, a);
    }
    if (e.verify) {
        var c = Fe(t, e.verify);
        return new Mn(c, n);
...
function Ye(t, e) {
    ...
    return null !== s && (n.structuredQuery.limit = s), e.startAt && (n.structuredQuery.startAt = Ze(e.startAt)), 
...
function He(t) {
    ...
    var h = null;
    return n.endAt && (h = Xe(n.endAt)), er(Qn(e, i, u, s, a, "F" /* First */ , c, h));
}
 ...
 */ function cn(t, e, n) {
    return t instanceof ln ? function(t, e) {
        ...
        var n = fn(t, e), r = mn(n) + mn(t.We);
        return Ie(n) && Ie(t.We) ? ke(r) : xe(t.serializer, r);
    }(t, e);
}
 ...
 */ function fn(t, e) {
    return t instanceof gn ? Ie(n = e) || function(t) {
 ...
 */ function An(t, e, n) {
    return t instanceof Vn ? function(t, e, n) {
        ...
        if (k(null != n.transformResults), !Tn(t.Ke, e)) 
        // Since the mutation was not rejected, we know that the  precondition
        // matched on the backend. We therefore must not have the expected version
        // of the document in our cache and return an UnknownDocument with the
        // known updateTime.
 ...
 */
        function(t, e, n) {
            ...
            for (var i = 0; i < n.length; i++) {
                ...
                e instanceof Gn && (u = e.field(o.field)), r.push(hn(s, u, n[i]));
            }
            return r;
        }(t.fieldTransforms, e, n.transformResults), o = n.version, s = Pn(t, r.data(), i);
 ...
 */ function Sn(t, e, n, r) {
    return t instanceof Vn ? function(t, e) {
    ...
    }(t, e) : t instanceof Ln ? function(t, e, n, r) {
        if (!Tn(t.Ke, e)) return e;
        var i = Un(t, e), o = function(t, e, n, r) {
            ...
            return i;
        }(t.fieldTransforms, n, e, r), s = Pn(t, i.data(), o);
        return new Gn(t.key, i.version, s, {
            Ye: !0
        });
    }(t, e, r, n) : function(t, e) {
        return Tn(t.Ke, e) ? new zn(t.key, mt.min()) : e;
    }(t, e);
}
 ...
 */ function Dn(t, e) {
    return t instanceof Ln ? function(t, e) {
        for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
            var o = i[r], s = e instanceof Gn ? e.field(o.field) : void 0, u = fn(o.transform, s || null);
    ...
    return t.type === e.type && !!t.key.isEqual(e.key) && !!t.Ke.isEqual(e.Ke) && (0 /* Set */ === t.type ? t.value.isEqual(e.value) : 1 /* Patch */ === t.type ? t.data.isEqual(e.data) && t.Qe.isEqual(e.Qe) : 2 /* Transform */ !== t.type || ut(t.fieldTransforms, t.fieldTransforms, (function(t, e) {
        return function(t, e) {
            return t.field.isEqual(e.field) && function(t, e) {
                return t instanceof pn && e instanceof pn || t instanceof vn && e instanceof vn ? ut(t.elements, e.elements, fe) : t instanceof gn && e instanceof gn ? fe(t.We, e.We) : t instanceof ln && e instanceof ln;
...
function Rn(t, e) {
    ...
    }(t, e instanceof Gn ? e.data() : Fn.empty());
}
...
/** A mutation that deletes the document at the given key. */ var Cn = /** @class */ function(e) {
    ...
    /** Returns an ObjectValue with all mutations applied. */ t.prototype.Je = function() {
        ...
        return null != t ? new Fn(t) : this.Xe;
    }, 
    /**
 ...
 */ function tr(t) {
    ...
    if (null === e.an) {
        ...
        n.p() || e.an.push(new _r(n)), e.an.push(new _r(C.v(), "asc" /* ASCENDING */)); else {
 ...
 */ function er(t) {
    var e = x(t);
    if (!e.cn) if ("F" /* First */ === e.on) e.cn = _t(e.path, e.collectionGroup, tr(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
...
var hr = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        if (t.p()) return "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.hn(t, e, r) : new fr(t, e, r);
        if (_e(r)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new vr(t, r) : "in" /* IN */ === e ? new yr(t, r) : "not-in" /* NOT_IN */ === e ? new gr(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new mr(t, r) : new n(t, e, r);
    }, n.hn = function(t, e, n) {
        return "in" /* IN */ === e ? new lr(t, n) : new pr(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.ln(pe(e, this.value)) : null !== e && he(this.value) === he(e) && this.ln(pe(e, this.value));
 ...
 */ function Ir(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.p() ? M.i(M.C(s.referenceValue), n.key) : pe(s, n.field(o.field)), 
 ...
 */ var Ar = function() {
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return T("SimpleDb", "Removing database:", t), Ur(window.indexedDB.deleteDatabase(t)).Nn();
    }, 
                  ...
                  case 0:
                    ...
                    e = this, [ 4 /*yield*/ , new Promise((function(e, n) {
                        ...
                        i.onsuccess = function(t) {
                            ...
                            n(new Vr(t, "Cannot upgrade IndexedDB schema while another tab is open. Close all tabs that access Firestore and reload this page to proceed."));
                        }, i.onerror = function(e) {
                            var r = e.target.error;
                            "VersionError" === r.name ? n(new I(b.FAILED_PRECONDITION, "A newer version of the Firestore SDK was previously used and so the persisted data is not compatible with the version of the SDK you are now using. The SDK will operate with persistence disabled. If you need persistence, please re-upgrade to a newer version of the SDK or else clear the persisted IndexedDB data for your app to start fresh.")) : n(new Vr(t, r));
                        }, i.onupgradeneeded = function(t) {
                            T("SimpleDb", 'Database "' + r.name + '" requires upgrade from version:', t.oldVersion);
                            var e = t.target.result;
                            r.kn.createOrUpgrade(e, i.transaction, t.oldVersion, r.version).next((function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 2:
                                ...
                                // caller.
                                return a.db = n.sent(), r = Rr.open(a.db, t, e ? "readonly" : "readwrite", i), u = o(r).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return r.abort(t), Dr.reject(t);
                                })).Nn(), c = {}, u.catch((function() {})), [ 4 /*yield*/ , r.Kn ];
 ...
 */ var Rr = /** @class */ function() {
    function t(t, e) {
        ...
        /**
             ...
             */
        this.Xn = new Ar, this.transaction.oncomplete = function() {
            n.Xn.resolve();
        }, this.transaction.onabort = function() {
            e.error ? n.Xn.reject(new Vr(t, e.error)) : n.Xn.resolve();
        }, this.transaction.onerror = function(e) {
            var r = Cr(e.target.error);
            n.Xn.reject(new Vr(t, r));
        };
    }
    ...
    t.prototype.add = function(t) {
        return T("SimpleDb", "ADD", this.store.name, t, t), Ur(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return Ur(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), T("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return T("SimpleDb", "DELETE", this.store.name, t), Ur(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return T("SimpleDb", "COUNT", this.store.name), Ur(this.store.count());
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function Mr() {
 ...
 */ var qr = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.os = t, this.fn = e, this.cs = n, this.op = r, this.us = i, this.hs = new Ar, 
    ...
    function t() {
        ...
        this.gs = new Sr(this, "async_queue_retry" /* AsyncQueueRetry */), 
 ...
 */
    ...
    t.prototype.gn = function(t, e, n) {
        ...
        var i = qr.ls(this, t, e, n, (function(t) {
            return r.Ns(t);
        }));
 ...
 */
function Br(t, e) {
    if (N("AsyncQueue", e + ": " + t), Or(t)) return new I(b.UNAVAILABLE, e + ": " + t);
    throw t;
}
...
var Gr = function() {
    ...
    this.Ls = new yt((function(t) {
        return sr(t);
    }), or), this.onlineState = "Unknown" /* Unknown */ , this.Bs = new Set;
};
...
function Wr(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                if (e = x(t), i = r.query, o = !1, (s = e.Ls.get(i)) || (o = !0, s = new Gr), !o) return [ 3 /*break*/ , 4 ];
                n.label = 1;
              ...
              case 3:
                return a = n.sent(), c = Br(a, "Initialization of query '" + ur(r.query) + "' failed"), 
                [ 2 /*return*/ , void r.onError(c) ];

              case 4:
                return e.Ls.set(i, s), s.listeners.push(r), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                r.Us(e.onlineState), s.Os && r.Qs(s.Os) && Hr(e), [ 2 /*return*/ ];
            }
        }));
    }));
}
...
function Kr(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o, s, u;
        return n(this, (function(n) {
            return e = x(t), i = r.query, o = !1, (s = e.Ls.get(i)) && (u = s.listeners.indexOf(r)) >= 0 && (s.listeners.splice(u, 1), 
 ...
 * readable.
 */
/** A user with a null UID. */ Zr.UNAUTHENTICATED = new Zr(null), 
// TODO(mikelehen): Look into getting a proper uid-equivalent for
// non-FirebaseAuth providers.
Zr.ti = new Zr("google-credentials-uid"), Zr.ei = new Zr("first-party-uid");
...
var ni = /** @class */ function() {
    ...
    function t(t, e, n, r, i) {
        ...
        this.fi = null, this.ni = null, this.di = this.wi.bind(this), this.mi = new Rt(st), 
        this.Ti = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Ii = Jr(this.persistenceKey, this.li), 
        this.Ai = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.mi = this.mi.rt(this.li, new si), this.Ri = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    for (t = n.sent(), e = 0, r = t; e < r.length; e++) (i = r[e]) !== this.li && (o = this.getItem(Jr(this.persistenceKey, i))) && (s = ii.ai(i, o)) && (this.mi = this.mi.rt(s.clientId, s));
    ...
    function t() {
        this.sr = new si, this.ir = {}, this.fi = null, this.ni = null;
    }
    return t.prototype.Fi = function(t) {
        ...
        return this.sr = new si, Promise.resolve();
    }, t.prototype.Wi = function(t, e, n) {
        // No op.
    }, t.prototype.ji = function(t) {
        // No op.
    ...
    t.prototype.ur = function(t, e) {
        ...
        for (var n = 0, r = this.baseMutations; n < r.length; n++) {
            var i = r[n];
            i.key.isEqual(t) && (e = Sn(i, e, e, this.rr));
        }
        // Second, apply all user-provided mutations.
        for (var o = e, s = 0, u = this.mutations; s < u.length; s++) {
            var a = u[s];
            a.key.isEqual(t) && (e = Sn(a, e, o, this.rr));
        }
        return e;
    }, 
    /**
    ...
    t.prototype.Ar = function(t, e) {
        this.Er();
        var n = this.dr.get(e);
        return void 0 !== n ? Dr.resolve(n) : this.Rr(t, e);
    }, 
    /**
    ...
    t.prototype.kr = function(t, e) {
        ...
        return this.vr.Mr(t, e).next((function(r) {
            ...
            return i.forEach((function(t, e) {
                ...
                e || (e = new zn(t, mt.min())), o = o.rt(t, e);
            })), o;
        }));
    }, 
    /**
 ...
 */
        return function(t) {
            return M.F(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Lr(t, e.path) : Jn(e) ? this.Br(t, e, n) : this.qr(t, e, n);
        ...
        // Query the remote documents and overlay mutations.
            ...
            return i = e, o.Wr(t, i, r).next((function(t) {
                ...
                for (var e = 0, n = i; e < n.length; e++) for (var o = n[e], s = 0, u = o.mutations; s < u.length; s++) {
                    var a = u[s], c = a.key, h = r.get(c), f = Sn(a, h, h, o.rr);
 ...
 */ var gi = /** @class */ function() {
    function t(t) {
        this.zr = t, this.buffer = new Pt(yi), this.Hr = 0;
    }
...
wi.uo = -1, wi.ho = 1048576, wi.lo = 41943040, wi.ao = 10, wi.co = 1e3, wi._o = new wi(wi.lo, wi.ao, wi.co), 
wi.fo = new wi(wi.uo, 0, 0);
...
var bi = /** @class */ function() {
    ...
    return t.prototype.start = function(t) {
        this.do.params.so !== wi.uo && this.To(t);
            ...
            return e(r, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return Or(e = n.sent()) ? (T("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */ t.prototype.Po = function(t, e) {
        var n = this;
        if (0 === e) return Dr.resolve(Xr.oi);
        var r = new gi(e);
    ...
    t.prototype.po = function(t, e) {
        ...
        var n = this;
        return this.params.so === wi.uo ? (T("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        Dr.resolve(mi)) : this.vo(t).next((function(r) {
 ...
 */ function Ni(t) {
    ...
    var e = t.length;
    if (k(e >= 2), 2 === e) return k("" === t.charAt(0) && "" === t.charAt(1)), U.g();
...
/** Decodes a remote document from storage locally to a Document. */ function Si(t, e) {
    if (e.document) return function(t, e, n) {
        var r = Fe(t, e.name), i = Ue(e.updateTime), o = new Fn({
            mapValue: {
                fields: e.fields
            }
        });
    ...
    if (e.noDocument) {
        var n = M.$(e.noDocument.path), r = Oi(e.noDocument.readTime);
        return new zn(n, r, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        var i = M.$(e.unknownDocument.path), o = Oi(e.unknownDocument.version);
        return new Wn(i, o);
    }
    return D();
}
...
/** Decodes a DbTarget into TargetData */ function Li(t) {
    var e, n, r = Oi(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Oi(t.lastLimboFreeSnapshotVersion) : mt.min();
    return void 0 !== t.query.documents ? (k(1 === (n = t.query).documents.length), 
    e = er(Yn(je(n.documents[0])))) : e = He(t.query), new kt(e, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, r, i, ct.fromBase64String(t.resumeToken))
    /** Encodes TargetData into a DbTarget for storage locally. */;
}

function Ui(t, e) {
    var n, r = Vi(e.et), i = Vi(e.lastLimboFreeSnapshotVersion);
    n = At(e.target) ? Qe(t.Do, e.target) : Ye(t.Do, e.target);
 ...
 * limitations under the License.
 */
/** A mutation queue for a specific user, backed by IndexedDB. */ var Pi = /** @class */ function() {
    function t(
    /**
    ...
    return t.Fo = function(e, n, r, i) {
        ...
        return k("" !== e.uid), new t(e.Xs() ? e.uid : "", n, r, i);
        ...
        return s.add({}).next((function(u) {
            ...
            for (var a = new ci(u, e, n, r), c = function(t, e, n) {
                ...
                return new to(e, n.batchId, n.rr.toMillis(), r, i);
        ...
        return Fi(t).get(e).next((function(t) {
            return t ? (k(t.userId === n.userId), Ri(n.serializer, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.Oo = function(t, e) {
        var n = this;
        return this.No[e] ? Dr.resolve(this.No[e]) : this.Mo(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.No[e] = r, r;
            }
        ...
        return Fi(t).ss({
            ...
            e.userId === n.userId && (k(e.batchId >= r), o = Ri(n.serializer, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return Fi(t).Zn(to.userMutationsIndex, n).next((function(t) {
            return t.map((function(t) {
                return Ri(e.serializer, t);
            }));
        }));
        ...
        // the given documentKey.
            ...
            return Fi(t).get(c).next((function(t) {
                if (!t) throw D();
                k(t.userId === n.userId), o.push(Ri(n.serializer, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new Pt(st), i = [];
        return e.forEach((function(e) {
            var o = eo.prefixForPath(n.userId, e.path), s = IDBKeyRange.lowerBound(o), u = qi(t).ss({
                range: s
            }, (function(t, i, o) {
        ...
        var n = this, r = e.path, i = r.length + 1, o = eo.prefixForPath(this.userId, r), s = IDBKeyRange.lowerBound(o), u = new Pt(st);
        return qi(t).ss({
            range: s
        }, (function(t, e, o) {
        ...
        return e.forEach((function(e) {
            i.push(Fi(t).get(e).next((function(t) {
                if (null === t) throw D();
                k(t.userId === n.userId), r.push(Ri(n.serializer, t));
            })));
        })), Dr.$n(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return Mi(t.Wo, this.userId, e).next((function(r) {
 ...
 */ function Mi(t, e, n) {
    var r = t.store(to.store), i = t.store(eo.store), o = [], s = IDBKeyRange.only(n.batchId), u = 0, a = r.ss({
        range: s
    }, (function(t, e, n) {
        return u++, n.delete();
    }));
 ...
 */ function Fi(t) {
    return _o.Un(t, to.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function qi(t) {
    return _o.Un(t, eo.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function ji(t) {
    return _o.Un(t, Ji.store);
}
 ...
 */ var Bi = /** @class */ function() {
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return Wi(t).get(Ki(e)).next((function(t) {
            return n.Jo(t);
        }));
    }, 
    /**
    ...
    t.prototype.ea = function(t, e) {
        var n = this, r = qt(), i = new Rt(M.i);
        return this.ta(t, e, (function(t, e) {
            var o = n.Jo(e);
            o ? (r = r.rt(t, o), i = i.rt(t, Qi(e))) : (r = r.rt(t, null), i = i.rt(t, 0));
        })).next((function() {
            return {
                na: r,
                sa: i
        ...
        return Wi(t).ss(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                ...
                e.path.T(u.key.path) ? u instanceof Gn && ar(e, u) && (i = i.rt(u.key, u)) : s.done();
            }
        })).next((function() {
            return i;
        }));
    }, t.prototype.ia = function(t) {
        return new Gi(this, !!t && t.ra);
    }, t.prototype.oa = function(t) {
        return this.getMetadata(t).next((function(t) {
            return t.byteSize;
        }));
    }, t.prototype.getMetadata = function(t) {
        return zi(t).get(oo.key).next((function(t) {
            return k(!!t), t;
        }));
    }, t.prototype.Yo = function(t, e) {
        return zi(t).put(oo.key, e);
    }, 
    /**
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).aa = t, r.ra = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.ca = new yt((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
        })), r;
    ...
    return t(n, e), n.prototype.gr = function(t) {
        ...
        return this.dr.forEach((function(o, s) {
            var u = e.ca.get(o);
            if (s) {
                var a = Di(e.aa.serializer, s, e.readTime);
                i = i.add(o.path.h());
                var c = Qi(a);
                r += c - u, n.push(e.aa.Tr(t, o, a));
            } else if (r -= u, e.ra) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                var h = Di(e.aa.serializer, new zn(o, mt.min()), e.readTime);
                n.push(e.aa.Tr(t, o, h));
            } else n.push(e.aa.Ir(t, o));
        })), i.forEach((function(r) {
            n.push(e.aa.Sr.ko(t, r));
        })), n.push(this.aa.updateMetadata(t, r)), Dr.$n(n);
    }, n.prototype.Rr = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute a delta later.
                return this.aa.Xo(t, e).next((function(t) {
            return null === t ? (n.ca.set(e, 0), null) : (n.ca.set(e, t.size), t.Zo);
        }));
    }, n.prototype.Pr = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute
        // a delta later.
                return this.aa.ea(t, e).next((function(t) {
            var e = t.na;
 ...
 */ function zi(t) {
    return _o.Un(t, oo.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function Wi(t) {
    return _o.Un(t, io.store);
}
 ...
 */ var Yi = /** @class */ function() {
    ...
    return t.prototype.ko = function(t, e) {
        return this.ua.add(e), Dr.resolve();
    }, t.prototype.Ur = function(t, e) {
        return Dr.resolve(this.ua.getEntries(e));
    }, t;
}(), Hi = /** @class */ function() {
    function t() {
        this.index = {};
    ...
    // Returns false if the entry already existed.
        ...
        var e = t._(), n = t.h(), r = this.index[e] || new Pt(U.i), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t._(), n = t.h(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new Pt(U.i)).A();
    }, t;
}(), $i = /** @class */ function() {
    function t(t) {
        this.serializer = t;
     ...
     */    return t.prototype.createOrUpgrade = function(t, e, n, r) {
        var i = this;
        k(n < r && n >= 0 && r <= 10);
        var o = new Rr("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store(to.store).Zn().next((function(n) {
        ...
        var e = 0;
        return t.store(io.store).ss((function(t, n) {
            e += Qi(n);
        })).next((function() {
            var n = new oo(e);
        ...
        var e = this, n = t.store(Ji.store), r = t.store(to.store);
        return n.Zn().next((function(n) {
            return Dr.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Zn(to.userMutationsIndex, i).next((function(r) {
                    return Dr.forEach(r, (function(r) {
                        k(r.userId === n.userId);
                        var i = Ri(e.serializer, r);
                        return Mi(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.ensureSequenceNumbers = function(t) {
        ...
        var n = e.store(co.store), r = new Hi, i = function(t) {
            if (r.add(t)) {
                var e = t._(), i = t.h();
                return n.put({
                    collectionId: e,
        ...
        // Index existing remote documents.
                return e.store(io.store).ss({
            ns: !0
        }, (function(t, e) {
            var n = new U(t);
            return i(n.h());
        })).next((function() {
            return e.store(eo.store).ss({
                ns: !0
            }, (function(t, e) {
                t[0];
        ...
        return n.ss((function(t, r) {
            var i = Li(r), o = Ui(e.serializer, i);
            return n.put(o);
        }));
    }, t;
}(), Zi = function(t, e) {
...
var lo = r(r(r([ Ji.store, to.store, eo.store, io.store, so.store, Xi.store, ao.store, uo.store ], [ fo.store ]), [ oo.store ]), [ co.store ]), po = /** @class */ function() {
    function t() {
        /**
     ...
     */    return t.prototype.ko = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return vo(t).Zn(r).next((function(t) {
 ...
 */ var yo = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        var e = this;
        return this.wa(t).next((function(n) {
            var r = new yo(n.highestTargetId);
            return n.highestTargetId = r.next(), e.ma(t, n).next((function() {
                return n.highestTargetId;
            }));
        }));
    }, t.prototype.Ta = function(t) {
        return this.wa(t).next((function(t) {
            return mt.Y(new gt(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds));
        }));
        ...
        var r = this;
        return this.wa(t).next((function(i) {
            return i.highestListenSequenceNumber = e, n && (i.lastRemoteSnapshotVersion = n.X()), 
            e > i.highestListenSequenceNumber && (i.highestListenSequenceNumber = e), r.ma(t, i);
        }));
    }, t.prototype.Aa = function(t, e) {
        var n = this;
        return this.Ra(t, e).next((function() {
            return n.wa(t).next((function(r) {
                return r.targetCount += 1, n.Pa(e, r), n.ma(t, r);
            }));
        }));
        ...
        var n = this;
        return this.Va(t, e.targetId).next((function() {
            return mo(t).delete(e.targetId);
        })).next((function() {
            return n.wa(t);
        })).next((function(e) {
            return k(e.targetCount > 0), e.targetCount -= 1, n.ma(t, e);
        }));
    }, 
    /**
    ...
    t.prototype.De = function(t, e) {
        ...
        return mo(t).put(Ui(this.serializer, e));
    }, 
    /**
    ...
    t.prototype.Pa = function(t, e) {
        ...
        // IndexedDb.
                return e.forEach((function(e) {
            var s = Ei(e.path);
            i.push(o.put(new uo(n, s))), i.push(r.Co.Sa(t, n, e));
        })), Dr.$n(i);
        ...
        // IndexedDb.
            ...
            var o = Ei(e.path);
            return Dr.$n([ i.delete([ n, o ]), r.Co.Ca(t, n, e) ]);
        }));
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = bo(t), i = Wt();
        return r.ss({
            range: n,
            ns: !0
        }, (function(t, e, n) {
            var r = Ni(t[1]), o = new M(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
 ...
 */
function mo(t) {
    return _o.Un(t, so.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function wo(t) {
    return _o.Un(t, ao.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function bo(t) {
    return _o.Un(t, uo.store);
}
 ...
 */ var Io = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Eo = /** @class */ function(e) {
    ...
    h) {
        ...
        this._n = o, this.window = s, this.document = u, this.$a = c, this.xa = h, this.ka = null, 
        this.Ma = !1, this.isPrimary = !1, this.networkEnabled = !0, 
        /** Our window.unload handler, if registered. */
        this.Oa = null, this.inForeground = !1, 
        /** Our 'visibilitychange' listener if registered. */
        this.La = null, 
        /** The client metadata refresh task. */
        this.Ba = null, 
        /** The last time we garbage collected the client metadata object store. */
        this.qa = Number.NEGATIVE_INFINITY, 
        ...
        this.Co = new Ao(this, i), this.Qa = n + "main", this.serializer = new Ai(a), this.Wa = new kr(this.Qa, 10, new $i(this.serializer)), 
        this.ja = new go(this.Co, this.serializer), this.Sr = new po, this.br = function(t, e) {
            return new Bi(t, e);
        }(this.serializer, this.Sr), this.window && this.window.localStorage ? this.Ka = this.window.localStorage : (this.Ka = null, 
    ...
    return t.Un = function(t, e) {
        if (t instanceof Eo) return kr.Un(t.Wo, e);
        throw D();
    }, 
    /**
    ...
    t.prototype.start = function() {
        ...
        // do.
            ...
            return t.za(), t.Ha(), t.Ya(), t.runTransaction("getHighestListenSequenceNumber", "readonly", (function(e) {
                return t.ja.Ea(e);
            }));
        })).then((function(e) {
            t.ka = new Xr(e, t.$a);
        ...
        this._n.ds((function() {
            return e(r, void 0, void 0, (function() {
                return n(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return this.Ti ? [ 4 /*yield*/ , this.Ga() ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.Ga = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return No(e).put(new fo(t.clientId, Date.now(), t.networkEnabled, t.inForeground)).next((function() {
                if (t.isPrimary) return t.tc(e).next((function(e) {
                ...
                return t.isPrimary && !n ? t.nc(e).next((function() {
                    return !1;
                })) : !!n && t.sc(e).next((function() {
                    return !0;
                }));
            }));
        })).catch((function(e) {
        ...
        var e = this;
        return To(t).get(Xi.key).next((function(t) {
            return Dr.resolve(e.ic(t));
        }));
    ...
    t.prototype.oc = function() {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return !this.isPrimary || this.ac(this.qa, 18e5) ? [ 3 /*break*/ , 2 ] : (this.qa = Date.now(), 
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(e) {
                        var n = t.Un(e, fo.store);
                        return n.Zn().next((function(t) {
                            var e = s.cc(t, 18e5), r = t.filter((function(t) {
                  ...
                  case 1:
                    ...
                    if (e = n.sent(), this.Ka) for (r = 0, i = e; r < i.length; r++) o = i[r], this.Ka.removeItem(this.uc(o.clientId));
                    n.label = 2;
    ...
    t.prototype.Ya = function() {
        var t = this;
        this.Ba = this._n.gn("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
    ...
    /** Checks whether `client` is the local client. */ t.prototype.ic = function(t) {
    ...
    t.prototype.ec = function(t) {
        var e = this;
        return this.xa ? Dr.resolve(!0) : To(t).get(Xi.key).next((function(n) {
            ...
            if (null !== n && e.ac(n.leaseTimestampMs, 5e3) && !e.hc(n.ownerId)) {
                if (e.ic(n) && e.networkEnabled) return !0;
                if (!e.ic(n)) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || No(t).Zn().next((function(t) {
                return void 0 === e.cc(t, 5e3).find((function(t) {
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.Ma = !1, this.lc(), this.Ba && (this.Ba.cancel(), this.Ba = null), this._c(), 
                    this.fc(), [ 4 /*yield*/ , this.Wa.runTransaction("shutdown", "readwrite", [ Xi.store, fo.store ], (function(e) {
                        var n = new Eo(e, Xr.oi);
                        return t.nc(n).next((function() {
                            return t.rc(n);
                        }));
                    })) ];
    ...
    t.prototype.cc = function(t, e) {
        ...
        return t.filter((function(t) {
            return n.ac(t.updateTimeMs, e) && !n.hc(t.clientId);
        }));
    }, 
    /**
    ...
    t.prototype.Vi = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return No(e).Zn().next((function(e) {
                return t.cc(e, 18e5).map((function(t) {
                    return t.clientId;
                }));
            }));
        }));
        ...
        return Pi.Fo(t, this.serializer, this.Sr, this.Co);
        ...
        return this.Wa.runTransaction(t, o, lo, (function(o) {
            return i = new Eo(o, r.ka ? r.ka.next() : Xr.oi), "readwrite-primary" === e ? r.tc(i).next((function(t) {
                return !!t || r.ec(i);
            })).next((function(e) {
                ...
                return r.sc(i).next((function() {
                    return t;
                }));
            })) : r.Ic(i).next((function() {
                return n(i);
            }));
        })).then((function(t) {
            return i.pr(), t;
    ...
    t.prototype.Ic = function(t) {
        var e = this;
        return To(t).get(Xi.key).next((function(t) {
            if (null !== t && e.ac(t.leaseTimestampMs, 5e3) && !e.hc(t.ownerId) && !e.ic(t) && !(e.xa || e.allowTabSynchronization && t.allowTabSynchronization)) throw new I(b.FAILED_PRECONDITION, Io);
        }));
    }, 
    /**
    ...
    t.prototype.sc = function(t) {
        var e = new Xi(this.clientId, this.allowTabSynchronization, Date.now());
        return To(t).put(Xi.key, e);
    }, t.On = function() {
        return kr.On();
    }, 
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.nc = function(t) {
        var e = this, n = To(t);
        return n.get(Xi.key).next((function(t) {
            return e.ic(t) ? (T("IndexedDbPersistence", "Releasing primary lease."), n.delete(Xi.key)) : Dr.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.ac = function(t, e) {
        ...
        var t = this;
        null !== this.document && "function" == typeof this.document.addEventListener && (this.La = function() {
            t._n.ds((function() {
                return t.inForeground = "visible" === t.document.visibilityState, t.Ga();
            }));
        }, this.document.addEventListener("visibilitychange", this.La), this.inForeground = "visible" === this.document.visibilityState);
    }, t.prototype._c = function() {
        this.La && (this.document.removeEventListener("visibilitychange", this.La), this.La = null);
    }, 
    /**
    ...
    t.prototype.Ha = function() {
        var t, e = this;
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.Oa = function() {
            // Note: In theory, this should be scheduled on the AsyncQueue since it
            // accesses internal state. We execute this code directly during shutdown
            // to make sure it gets a chance to run.
            e.lc(), e._n.ds((function() {
                return e.Si();
            }));
        }, this.window.addEventListener("unload", this.Oa));
    }, t.prototype.fc = function() {
        this.Oa && (this.window.removeEventListener("unload", this.Oa), this.Oa = null);
    }, 
    /**
    ...
    t.prototype.hc = function(t) {
        var e;
        try {
            var n = null !== (null === (e = this.Ka) || void 0 === e ? void 0 : e.getItem(this.uc(t)));
    ...
    t.prototype.lc = function() {
        if (this.Ka) try {
            this.Ka.setItem(this.uc(this.clientId), String(Date.now()));
        } catch (t) {
            // Gracefully handle if LocalStorage isn't available / working.
            N("Failed to set zombie client id.", t);
        }
    }, 
    /** Removes the zombied client entry if it exists. */ t.prototype.dc = function() {
        if (this.Ka) try {
            this.Ka.removeItem(this.uc(this.clientId));
        } catch (t) {
            // Ignore
        }
...
/** Provides LRU functionality for IndexedDB persistence. */ var Ao = /** @class */ function() {
    ...
    return t.prototype.Ro = function(t) {
        ...
        return this.db.mc().De(t, e);
    }, t.prototype.yo = function(t, e) {
        return this.Rc(t, (function(t, n) {
            return e(n);
        }));
    ...
    t.prototype.Pc = function(t, e) {
        ...
        var n = this, r = this.db.Tc().ia(), i = [], o = 0;
        return this.Rc(t, (function(s, u) {
            if (u <= e) {
                var a = n.Pc(t, s).next((function(e) {
                    ...
                    return o++, r.Ar(t, s).next((function() {
                        return r.Ir(s), bo(t).delete([ 0, Ei(s.path) ]);
                    }));
                }));
                i.push(a);
            }
...
var ko = /** @class */ function() {
    ...
    t, e, n) {
        ...
        /**
             ...
             */
        this.vc = mt.min(), this.vr = t.wc(n), this.Sc = t.Tc(), this.ja = t.mc(), this.Dc = new di(this.Sc, this.vr, this.persistence.Ec()), 
        this.yc.Cc(this.Dc);
    }
        ...
        return function(t, e, n, r) {
            ...
            return o.forEach((function(t) {
                s = s.next((function() {
                    ...
                    k(null !== s), (!o || o.version.L(s) < 0) && ((o = i.ar(t, o, n)) && 
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.Gt.forEach((function(e, o) {
            ...
            if (u) {
                ...
                s.push(n.ja.Da(t, e.ne, o).next((function() {
                    return n.ja.va(t, e.te, o);
                })));
                var a = e.resumeToken;
                // Update the resume token if the change includes one.
                                if (a.O() > 0) {
                    var c = u.st(a, r).nt(t.Fa);
                    i = i.rt(o, c), 
     ...
     */
        ...
        s.push(o.getEntries(t, a).next((function(i) {
            e.Ht.forEach((function(a, c) {
                ...
                // cache.
                                c instanceof zn && c.version.isEqual(mt.min()) ? (
                ...
                e.Yt.has(a) && s.push(n.persistence.Co.gc(t, a));
            }));
        }))), !r.isEqual(mt.min())) {
            var c = n.ja.Ta(t).next((function(e) {
                return n.ja.Ia(t, t.Fa, r);
            }));
            s.push(c);
        }
 ...
 */ function Lo(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        var r;
        return n.ja.ba(t, e).next((function(i) {
            return i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            r = i, Dr.resolve(r)) : n.ja.da(t).next((function(i) {
                return r = new kt(e, i, 0 /* Listen */ , t.Fa), n.ja.Aa(t, r).next((function() {
                    return r;
                }));
            }));
        }));
        ...
        // the in-memory data
        var r = n.Vc.get(t.targetId);
        return (null === r || t.et.L(r.et) > 0) && (n.Vc = n.Vc.rt(t.targetId, t), n.bc.set(e, t.targetId)), 
        t;
    }));
}
...
function Uo(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = x(t), o = e.Vc.get(r), s = i ? "readwrite" : "readwrite-primary", n.label = 1;
              ...
              case 5:
                return e.Vc = e.Vc.remove(r), e.bc.delete(o.target), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function Po(t, e, n) {
    var r = x(t), i = mt.min(), o = Wt();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = x(t), i = r.bc.get(n);
            return void 0 !== i ? Dr.resolve(r.Vc.get(i)) : r.ja.ba(e, n);
        }(r, t, er(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.ja.Na(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.yc.Or(t, e, n ? i : mt.min(), n ? o : Wt());
        })).next((function(t) {
            return {
                documents: t,
                Nc: o
...
// PORTING NOTE: Multi-Tab only.
function Co(t, e) {
    var n = x(t), r = x(n.ja), i = n.Vc.get(e);
...
function Mo(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = x(t), i = Ft(), o = ki(n), s = Wi(e), u = IDBKeyRange.lowerBound(o, !0);
            return s.ss({
 ...
 */ var jo = /** @class */ function() {
    function t() {
        ...
        this.kc = new Pt(Bo.Mc)
        /** Returns true if the reference set contains no references. */;
    }
    return t.prototype.m = function() {
        return this.$c.m();
    }, 
    /** Adds a reference to the given document key for the given ID. */ t.prototype.Sa = function(t, e) {
        var n = new Bo(t, e);
        this.$c = this.$c.add(n), this.kc = this.kc.add(n);
    }, 
    /** Add references to the given document keys for the given ID. */ t.prototype.Oc = function(t, e) {
        var n = this;
    ...
    t.prototype.qc = function(t) {
        var e = this, n = new M(new U([])), r = new Bo(n, t), i = new Bo(n, t + 1), o = [];
        return this.kc.Nt([ r, i ], (function(t) {
            e.Lc(t), o.push(t.key);
        })), o;
        ...
        this.$c = this.$c.delete(t), this.kc = this.kc.delete(t);
    }, t.prototype.Qc = function(t) {
        var e = new M(new U([])), n = new Bo(e, t), r = new Bo(e, t + 1), i = Wt();
        return this.kc.Nt([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.zo = function(t) {
        var e = new Bo(t, 0), n = this.$c.$t(e);
        return null !== n && t.isEqual(n.key);
    }, t;
}(), Bo = /** @class */ function() {
    function t(t, e) {
        this.key = t, this.Wc = e
        /** Compare by key then by ID */;
    }
    return t.xc = function(t, e) {
        return M.i(t.key, e.key) || st(t.Wc, e.Wc);
    }, 
    /** Compare by ID then by key */ t.Mc = function(t, e) {
        return st(t.Wc, e.Wc) || M.i(t.key, e.key);
    }, t;
}(), Go = function(t, e) {
    this.user = e, this.type = "OAuth", this.jc = {}, 
    // Set the headers using Object Literal notation to avoid minification
    this.jc.Authorization = "Bearer " + t;
}, zo = /** @class */ function() {
    function t() {
        /**
    ...
    }, t.prototype.Gc = function() {}, t.prototype.zc = function(t) {
        this.Kc = t, 
        // Fire with initial user.
        t(Zr.UNAUTHENTICATED);
    ...
    function t(t) {
        ...
        this.currentUser = Zr.UNAUTHENTICATED, this.Jc = !1, 
        /**
        ...
        this.Kc = null, this.forceRefresh = !1, this.Yc = function() {
            e.Xc++, e.currentUser = e.Zc(), e.Jc = !0, e.Kc && e.Kc(e.currentUser);
        }, this.Xc = 0, this.auth = t.getImmediate({
            optional: !0
        }), this.auth ? this.auth.addAuthTokenListener(this.Yc) : (
        // if auth is not available, invoke tokenListener once with null token
        this.Yc(null), t.get().then((function(t) {
            e.auth = t, e.Yc && 
            // tokenListener can be removed by removeChangeListener()
            e.auth.addAuthTokenListener(e.Yc);
        }), (function() {})));
    }
    return t.prototype.getToken = function() {
        var t = this, e = this.Xc, n = this.forceRefresh;
        ...
        // request is outstanding.
            ...
            return t.Xc !== e ? (T("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
            t.getToken()) : n ? (k("string" == typeof n.accessToken), new Go(n.accessToken, t.currentUser)) : null;
        ...
        this.Jc && t(this.currentUser);
    }, t.prototype.Hc = function() {
        this.auth && this.auth.removeAuthTokenListener(this.Yc), this.Yc = null, this.Kc = null;
    }, 
    ...
    t.prototype.Zc = function() {
        ...
        return k(null === t || "string" == typeof t), new Zr(t);
    }, t;
}(), Ko = /** @class */ function() {
    function t(t, e) {
        this.tu = t, this.eu = e, this.type = "FirstParty", this.user = Zr.ei;
    }
    return Object.defineProperty(t.prototype, "jc", {
        get: function() {
            var t = {
                "X-Goog-AuthUser": this.eu
            }, e = this.tu.auth.getAuthHeaderValueForFirstParty([]);
    ...
    return t.prototype.getToken = function() {
        return Promise.resolve(new Ko(this.tu, this.eu));
    }, t.prototype.zc = function(t) {
        // Fire with initial uid.
        t(Zr.ei);
    }, t.prototype.Hc = function() {}, t.prototype.Gc = function() {}, t;
}(), Yo = /** @class */ function() {
    function t(t, e, n, r, i, o) {
        this._n = t, this.nu = n, this.su = r, this.iu = i, this.listener = o, this.state = 0 /* Initial */ , 
        /**
             * A close count that's incremented every time the stream is closed; used by
             * getCloseGuardedDispatcher() to invalidate callbacks that happen after
             * close.
             */
        this.ru = 0, this.ou = null, this.stream = null, this.gs = new Sr(t, e)
        /**
     ...
     */
    t.prototype.start = function() {
        3 /* Error */ !== this.state ? this.auth() : this.uu();
    }, 
    /**
    ...
    t.prototype.stop = function() {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.au() ? [ 4 /*yield*/ , this.close(0 /* Initial */) ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.lu = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.cu() && null === this.ou && (this.ou = this._n.gn(this.nu, 6e4, (function() {
            return t._u();
        })));
    }, 
    /** Sends a message to the underlying stream. */ t.prototype.fu = function(t) {
        this.du(), this.stream.send(t);
    }, 
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype._u = function() {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                return this.cu() ? [ 2 /*return*/ , this.close(0 /* Initial */) ] : [ 2 /*return*/ ];
            }));
        }));
    }, 
    /** Marks the stream as active again. */ t.prototype.du = function() {
        this.ou && (this.ou.cancel(), this.ou = null);
    }, 
    /**
            ...
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    null !== this.stream && (this.wu(), this.stream.close(), this.stream = null), 
                    // This state must be assigned before calling onClose() to allow the callback to
                    // inhibit backoff or otherwise manipulate the state in its non-started state.
                    this.state = t, [ 4 /*yield*/ , this.listener.mu(r) ];
     ...
     */
    t.prototype.wu = function() {}, t.prototype.auth = function() {
        var t = this;
        this.state = 1 /* Starting */;
        var e = this.Tu(this.ru), n = this.ru;
        // TODO(mikelehen): Just use dispatchIfNotClosed, but see TODO below.
                this.iu.getToken().then((function(e) {
        ...
        var e = this, n = this.Tu(this.ru);
        this.stream = this.Au(t), this.stream.Ru((function() {
            n((function() {
                return e.state = 2 /* Open */ , e.listener.Ru();
            }));
        })), this.stream.mu((function(t) {
            n((function() {
                return e.Iu(t);
            }));
    ...
    t.prototype.Tu = function(t) {
        ...
        return function(n) {
            e._n.ds((function() {
                return e.ru === t ? n() : (T("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    return t(n, e), n.prototype.Au = function(t) {
        return this.su.Pu("Listen", t);
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    return t.Ue ? (k(void 0 === e || "string" == typeof e), ct.fromBase64String(e || "")) : (k(void 0 === e || e instanceof Uint8Array), 
                    ct.fromUint8Array(e || new Uint8Array));
                }(t, e.targetChange.resumeToken), s = e.targetChange.cause, u = s && function(t) {
                    var e = void 0 === t.code ? b.UNKNOWN : Ot(t.code);
                ...
                var c = Fe(t, a.document.name), h = Ue(a.document.updateTime), f = new Fn({
                    mapValue: {
                        fields: a.document.fields
                    }
                }), l = new Gn(c, h, f, {}), p = a.targetIds || [], d = a.removedTargetIds || [];
                n = new Jt(p, d, l.key, l);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var v = e.documentDelete;
                v.document;
                var y = Fe(t, v.document), g = v.readTime ? Ue(v.readTime) : mt.min(), m = new zn(y, g), w = v.removedTargetIds || [];
                n = new Jt([], w, m.key, m);
            } else if ("documentRemove" in e) {
                e.documentRemove;
                var E = e.documentRemove;
                E.document;
                var _ = Fe(t, E.document), T = E.removedTargetIds || [];
                n = new Jt([], T, _, null);
            } else {
            ...
            return e.targetIds && e.targetIds.length ? mt.min() : e.readTime ? Ue(e.readTime) : mt.min();
        }(t);
        return this.listener.gu(e, n);
    }, 
    /**
    ...
    n.prototype.yu = function(t) {
        ...
        e.database = Be(this.serializer), e.addTarget = function(t, e) {
            ...
            return (n = At(r) ? {
                ...
                query: Ye(t, r)
            }).targetId = e.targetId, e.resumeToken.O() > 0 && (n.resumeToken = Re(t, e.resumeToken)), 
            n;
        }(this.serializer, t);
        var n = function(t, e) {
            var n = function(t, e) {
    ...
    n.prototype.Vu = function(t) {
        var e = {};
        e.database = Be(this.serializer), e.removeTarget = t, this.fu(e);
    }, n;
    ...
    return t(n, e), Object.defineProperty(n.prototype, "bu", {
        /**
    ...
    n.prototype.start = function() {
        this.pu = !1, this.lastStreamToken = void 0, e.prototype.start.call(this);
    }, n.prototype.wu = function() {
        this.pu && this.vu([]);
    }, n.prototype.Au = function(t) {
        return this.su.Pu("Write", t);
    }, n.prototype.onMessage = function(t) {
        if (
        // Always capture the last stream token.
        k(!!t.streamToken), this.lastStreamToken = t.streamToken, this.pu) {
            ...
            return this.listener.Su(n, e);
        }
        // The first response is always the handshake response
                return k(!t.writeResults || 0 === t.writeResults.length), this.pu = !0, 
        this.listener.Du();
    }, 
    /**
    ...
    n.prototype.Cu = function() {
        ...
        var t = {};
        t.database = Be(this.serializer), this.fu(t);
    }, 
    /** Sends a group of mutations to the Firestore backend to apply. */ n.prototype.vu = function(t) {
        var e = this, n = {
...
}(Yo), Zo = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).credentials = t, i.su = n, i.serializer = r, i.Nu = !1, 
        i;
    }
    return t(n, e), n.prototype.Fu = function() {
        if (this.Nu) throw new I(b.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Gets an auth token and invokes the provided RPC. */ n.prototype.$u = function(t, e, n) {
        var r = this;
        return this.Fu(), this.credentials.getToken().then((function(i) {
            return r.su.$u(t, e, n, i);
        })).catch((function(t) {
            throw t.code === b.UNAUTHENTICATED && r.credentials.Gc(), t;
        }));
    }, 
    /** Gets an auth token and invokes the provided RPC with streamed results. */ n.prototype.xu = function(t, e, n) {
        var r = this;
        return this.Fu(), this.credentials.getToken().then((function(i) {
            return r.su.xu(t, e, n, i);
        })).catch((function(t) {
            throw t.code === b.UNAUTHENTICATED && r.credentials.Gc(), t;
        }));
    ...
    return t.prototype.Lu = function() {
        var t = this;
        0 === this.ku && (this.Bu("Unknown" /* Unknown */), this.Mu = this.os.gn("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.Mu = null, t.qu("Backend didn't respond within 10 seconds."), t.Bu("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
    ...
    t.prototype.Uu = function(t) {
        "Online" /* Online */ === this.state ? this.Bu("Unknown" /* Unknown */) : (this.ku++, 
        this.ku >= 1 && (this.Qu(), this.qu("Connection failed 1 times. Most recent error: " + t.toString()), 
    ...
    t.prototype.set = function(t) {
        this.Qu(), this.ku = 0, "Online" /* Online */ === t && (
        ...
        this.Ou ? (N(e), this.Ou = !1) : T("OnlineStateTracker", e);
...
r, i, o, s) {
    var u = this;
    this.Wu = t, this.ju = r, this.os = i, this.Ku = {}, 
    /**
    ...
    /**
             ...
             */
    this.Yu = [], this.Ju = s, this.Ju.Xu((function(t) {
        i.ds((function() {
                        ...
                        [ 4 /*yield*/ , function(t) {
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = x(t)).Hu.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , es(e) ];

                                      case 1:
                                        return n.sent(), e.Zu.set("Unknown" /* Unknown */), e.Hu.delete(4 /* ConnectivityChange */), 
                                        [ 4 /*yield*/ , ts(e) ];
...
function ns(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = x(t), T("RemoteStore", "RemoteStore shutting down."), e.Hu.add(5 /* Shutdown */), 
                [ 4 /*yield*/ , es(e) ];

              case 1:
                return n.sent(), e.Ju.Si(), 
                // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                // triggering spurious listener events with cached data, etc.
                e.Zu.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ function is(t, e) {
    var n = x(t), r = Ts(n);
    n.zu.delete(e), r.cu() && ss(n, e), 0 === n.zu.size && (r.cu() ? r.lu() : cs(n) && 
    // Revert to OnlineState.Unknown if the watch stream is not open and we
    // have no listeners, since without any listens to send we cannot
    // confirm if the stream is healthy and upgrade to OnlineState.Online.
    n.Zu.set("Unknown" /* Unknown */));
}
...
function as(t) {
    return cs(t) && !Ts(t).au() && t.zu.size > 0;
}

function cs(t) {
    return 0 === x(t).Hu.size;
}
...
function fs(t) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            return t.zu.forEach((function(e, n) {
                os(t, e);
            })), [ 2 /*return*/ ];
        }));
    }));
...
function ls(t, r) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(e) {
            ...
            t.Zu.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
        }));
    }));
}
...
function ps(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(a) {
            switch (a.label) {
              case 0:
                if (t.Zu.set("Online" /* Online */), !(r instanceof ee && 2 /* Removed */ === r.state && r.cause)) 
                    ...
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 1:
                                return i < o.length ? (s = o[i], t.zu.has(s) ? [ 4 /*yield*/ , t.Ku.eh(s, e) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                              case 2:
                                n.sent(), t.zu.delete(s), t.th.removeTarget(s), n.label = 3;
              ...
              case 6:
                if (r instanceof Jt ? t.th.pe(r) : r instanceof te ? t.th.$e(r) : t.th.Se(r), i.isEqual(mt.min())) return [ 3 /*break*/ , 13 ];
                a.label = 7;

              case 7:
                return a.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Vo(t.Wu) ];
                    ...
                    // persistent view of these when applying the completed RemoteEvent.
                        ...
                        if (n.resumeToken.O() > 0) {
                            ...
                            // A watched target might have been removed already.
                                                        i && t.zu.set(r, i.st(n.resumeToken, e));
                        }
                    })), 
        ...
        return n(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.Hu.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , es(t) ];

              case 1:
                // Disable network and raise offline snapshots
                return s.sent(), t.Zu.set("Offline" /* Offline */), i || (
                    ...
                    return e(o, void 0, void 0, (function() {
                        return n(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.Hu.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , ts(t) ];
...
function ys(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                e = x(t), r = Ns(e), i = e.Gu.length > 0 ? e.Gu[e.Gu.length - 1].batchId : -1, n.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return n.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , Ro(e.Wu, i) ];

              case 3:
                return null === (o = n.sent()) ? (0 === e.Gu.length && r.lu(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.Gu.push(e);
                    var n = Ns(t);
                    n.cu() && n.bu && n.vu(e.mutations);
                }(e, o), [ 3 /*break*/ , 6 ]);
...
function gs(t) {
    return cs(t) && !Ns(t).au() && t.Gu.length > 0;
}
...
function bs(t) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            ...
            for (e = Ns(t), r = 0, i = t.Gu; r < i.length; r++) o = i[r], e.vu(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function Is(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = t.Gu.shift(), o = hi.from(e, r, i), [ 4 /*yield*/ , vs(t, (function() {
                    return t.Ku.sh(o);
                })) ];
...
function Es(t, r) {
    return e(this, void 0, void 0, (function() {
        return n(this, (function(i) {
            switch (i.label) {
              case 0:
                return r && Ns(t).bu ? [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return Vt(i = r.code) && i !== b.ABORTED ? (e = t.Gu.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                Ns(t).hu(), [ 4 /*yield*/ , vs(t, (function() {
                                    return t.Ku.ih(e.batchId, r);
                                })) ]) : [ 3 /*break*/ , 3 ];
 ...
 */ function _s(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = x(t), r ? (e.Hu.delete(2 /* IsSecondary */), [ 4 /*yield*/ , ts(e) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return n.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return (i = r) ? [ 3 /*break*/ , 4 ] : (e.Hu.add(2 /* IsSecondary */), [ 4 /*yield*/ , es(e) ]);

              case 3:
                n.sent(), i = e.Zu.set("Unknown" /* Unknown */), n.label = 4;
 ...
 */ function Ts(t) {
    ...
    t.rh = function(t, e, n) {
        var r = x(t);
        return r.Fu(), new Ho(e, r.su, r.credentials, r.serializer, n);
    }(t.ju, t.os, {
        Ru: fs.bind(null, t),
        mu: ls.bind(null, t),
        gu: ps.bind(null, t)
    }), t.Yu.push((function(i) {
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.rh.hu(), as(t) ? us(t) : t.Zu.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.rh.stop() ];
...
function Ns(t) {
    ...
    t.oh = function(t, e, n) {
        var r = x(t);
        return r.Fu(), new $o(e, r.su, r.credentials, r.serializer, n);
    }(t.ju, t.os, {
        Ru: ws.bind(null, t),
        mu: Es.bind(null, t),
        Du: bs.bind(null, t),
        ...
        return e(r, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.oh.hu(), [ 4 /*yield*/ , ys(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 3:
                    e.sent(), t.Gu.length > 0 && (T("RemoteStore", "Stopping write stream with " + t.Gu.length + " pending writes"), 
                    t.Gu = []), e.label = 4;
...
var As = function(t) {
    ...
    e) {
        this.query = t, this.ah = e, this.uh = null, 
        /**
        ...
        this.Qt = Wt(), this.lh = cr(t), this._h = new Yt(this.lh);
    }
    return Object.defineProperty(t.prototype, "fh", {
        /**
    ...
    t.prototype.dh = function(t, e) {
        var n = this, r = e ? e.wh : new Ht, i = e ? e._h : this._h, o = e ? e.Qt : this.Qt, s = i, u = !1, a = Hn(this.query) && i.size === this.query.limit ? i.last() : null, c = $n(this.query) && i.size === this.query.limit ? i.first() : null;
        ...
        if (t.ut((function(t, e) {
            ...
            h && f ? h.data().isEqual(f.data()) ? l !== p && (r.track({
                type: 3 /* Metadata */ ,
                doc: f
            }), d = !0) : n.mh(h, f) || (r.track({
                type: 2 /* Modified */ ,
                doc: f
            }), d = !0, (a && n.lh(f, a) > 0 || c && n.lh(f, c) < 0) && (
            ...
            o = o.delete(t)));
        })), Hn(this.query) || $n(this.query)) for (;s.size > this.query.limit; ) {
            var h = Hn(this.query) ? s.last() : s.first();
    ...
    t.prototype.gr = function(t, e, n) {
        var r = this, i = this._h;
        this._h = t._h, this.Qt = t.Qt;
        ...
        o.sort((function(t, e) {
            return function(t, e) {
                ...
                return n(t) - n(e);
            }(t.type, e.type) || r.lh(t.doc, e.doc);
        })), this.Eh(n);
        var s = e ? this.Ih() : [], u = 0 === this.hh.size && this.Zt ? 1 /* Synced */ : 0 /* Local */ , a = u !== this.uh;
        return this.uh = u, 0 !== o.length || a ? {
            snapshot: new $t(this.query, t._h, i, o, t.Qt, 0 /* Local */ === u, a, 
            /* excludesMetadataChanges= */ !1),
            Ah: s
        } : {
            Ah: s
    ...
    t.prototype.Rh = function(t) {
        ...
        return !this.ah.has(t) && 
        // The local store doesn't think it's a result, so it shouldn't be in limbo.
        !!this._h.has(t) && !this._h.get(t).Ye;
    }, 
    /**
    ...
    t.prototype.Eh = function(t) {
        ...
        t && (t.te.forEach((function(t) {
            return e.ah = e.ah.add(t);
        })), t.ee.forEach((function(t) {})), t.ne.forEach((function(t) {
            return e.ah = e.ah.delete(t);
        })), this.Zt = t.Zt);
        ...
        // updating many documents.
                var e = this.hh;
        this.hh = Wt(), this._h.forEach((function(e) {
            t.Rh(e.key) && (t.hh = t.hh.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.hh.has(e) || n.push(new Ss(e));
        })), this.hh.forEach((function(t) {
    ...
    t.prototype.Ph = function(t) {
        this.ah = t.Nc, this.hh = Wt();
        var e = this.dh(t.documents);
    ...
    t.prototype.gh = function() {
        return $t.Kt(this.query, this._h, this.Qt, 0 /* Local */ === this.uh);
    }, t;
}(), ks = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        this.Wu = t, this.Vh = e, this.ph = n, this.bh = r, this.currentUser = i, this.Sh = o, 
        this.Dh = {}, this.Ch = new yt((function(t) {
            return sr(t);
        }), or), this.Nh = new Map, 
        /**
        ...
        /**
             ...
             */
        this.xh = new Map, this.kh = new jo, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Mh = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Oh = new Map, this.Lh = yo.fa(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                ...
                i = s.targetId, e.bh.Mi(i), o = s.view.gh(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , Lo(e.Wu, er(r)) ];

              case 2:
                return u = n.sent(), a = e.bh.Mi(u.targetId), i = u.targetId, [ 4 /*yield*/ , Rs(e, r, i, "current" === a) ];

              case 3:
                o = n.sent(), e.qh && rs(e.Vh, u), n.label = 4;
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(l) {
            switch (l.label) {
                    ...
                    return function(t, r, i, o) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = r.view.dh(i), e.Th ? [ 4 /*yield*/ , Po(t.Wu, r.query, 
                                    /* usePreviousResults= */ !1).then((function(t) {
                                        var n = t.documents;
                                        return r.view.dh(n, e);
                                    })) ] : [ 3 /*break*/ , 2 ];
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.qh, s), [ 2 /*return*/ , (zs(t, r.targetId, u.Ah), 
                                    u.snapshot) ];
                                }
                            }));
                        }));
              ...
              case 1:
                return s = l.sent(), u = new Ds(r, s.Nc), a = u.dh(s.documents), c = Xt.Xt(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = u.gr(a, 
                /* updateLimboDocuments= */ t.qh, c), zs(t, i, h.Ah), f = new ks(r, i, u), [ 2 /*return*/ , (t.Ch.set(r, f), 
                t.Nh.has(i) ? t.Nh.get(i).push(r) : t.Nh.set(i, [ r ]), h.snapshot) ];
            }
        }));
    }));
}

/** Stops listening to the query. */ function Ls(t, r) {
    return e(this, void 0, void 0, (function() {
        var e, i, o;
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return e = x(t), i = e.Ch.get(r), (o = e.Nh.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (e.Nh.set(i.targetId, o.filter((function(t) {
                    return !or(t, r);
                }))), void e.Ch.delete(r)) ] : e.qh ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                e.bh.Li(i.targetId), e.bh.Ni(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Uo(e.Wu, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    e.bh.qi(i.targetId), is(e.Vh, i.targetId), Bs(e, i.targetId);
                })).catch(qo) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return Bs(e, i.targetId), [ 4 /*yield*/ , Uo(e.Wu, i.targetId, 
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Oo(e.Wu, r) ];
 ...
 */ function Ps(t, e, n) {
    ...
    // SharedClientState.
        ...
        }(r.ph, e), i.length && r.Dh.gu(i), r.onlineState = e, r.qh && r.bh.ji(e);
    }
}
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (e = x(t)).bh.Ui(r, "rejected", i), o = e.xh.get(r), (s = o && o.key) ? (u = (u = new Rt(M.i)).rt(s, new zn(s, mt.min())), 
                a = Wt().add(s), c = new Zt(mt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new Pt(st), u, a), [ 4 /*yield*/ , Us(e, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                e.$h = e.$h.remove(s), e.xh.delete(r), Ks(e), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , Uo(e.Wu, r, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return Bs(e, r, i);
                })).catch(qo) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , xo(e.Wu, r) ];
              ...
              case 2:
                ...
                js(e, i, /*error=*/ null), qs(e, i), e.bh.xi(i, "acknowledged"), [ 4 /*yield*/ , Qs(e, o) ];
        ...
        return n(this, (function(n) {
            switch (n.label) {
                ...
                return n.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        ...
                        return n.vr.Mo(t, e).next((function(e) {
                            return k(null !== e), r = e.keys(), n.vr.Qo(t, e);
                        })).next((function() {
                            return n.vr.Go(t);
                        })).next((function() {
                            return n.Dc.$r(t, r);
              ...
              case 2:
                ...
                // listen events.
                js(e, r, i), qs(e, r), e.bh.xi(r, "rejected", i), [ 4 /*yield*/ , Qs(e, o) ];
...
function js(t, e, n) {
    var r = x(t), i = r.Mh[r.currentUser.Zs()];
    // NOTE: Mutations restored from persistence won't have callbacks, so it's
    // okay for there to be no callback for this ID.
    if (i) {
        var o = i.get(e);
        o && (n ? o.reject(n) : o.resolve(), i = i.remove(e)), r.Mh[r.currentUser.Zs()] = i;
    }
}

function Bs(t, e, n) {
    void 0 === n && (n = null), t.bh.Li(e);
    for (var r = 0, i = t.Nh.get(e); r < i.length; r++) {
        var o = i[r];
        t.Ch.delete(o), n && t.Dh.Qh(o, n);
    }
    t.Nh.delete(e), t.qh && t.kh.qc(e).forEach((function(e) {
        t.kh.zo(e) || 
...
function Gs(t, e) {
    ...
    var n = t.$h.get(e);
    null !== n && (is(t.Vh, n), t.$h = t.$h.remove(e), t.xh.delete(n), Ks(t));
}

function zs(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof As ? (t.kh.Sa(o.key, e), Ws(t, o)) : o instanceof Ss ? (T("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.kh.Ca(o.key, e), t.kh.zo(o.key) || 
        // We removed the last reference for this key
        Gs(t, o.key)) : D();
    }
}
...
function Ws(t, e) {
    var n = e.key;
    t.$h.get(n) || (T("SyncEngine", "New document in limbo: " + n), t.Fh.push(n), Ks(t));
}
 ...
 */ function Ks(t) {
    for (;t.Fh.length > 0 && t.$h.size < t.Sh; ) {
        var e = t.Fh.shift(), n = t.Lh.next();
        t.xh.set(n, new xs(e)), t.$h = t.$h.rt(e, n), rs(t.Vh, new kt(er(Yn(e.path)), n, 2 /* LimboResolution */ , Xr.oi));
    }
}
...
function Qs(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = x(t), s = [], u = [], a = [], o.Ch.m() ? [ 3 /*break*/ , 3 ] : (o.Ch.forEach((function(t, e) {
                    a.push(o.Uh(e, r, i).then((function(t) {
                        if (t) {
                            o.qh && o.bh.Ui(e.targetId, t.fromCache ? "not-current" : "current"), s.push(t);
                            var n = vi.Gr(e.targetId, t);
                            u.push(n);
                        }
                    })));
              ...
              case 1:
                return c.sent(), o.Dh.gu(s), [ 4 /*yield*/ , function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              ...
                              case 1:
                                return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , e.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return Dr.forEach(r, (function(n) {
                                        return Dr.forEach(n.jr, (function(r) {
                                            return e.persistence.Co.Sa(t, n.targetId, r);
                                        })).next((function() {
                                            return Dr.forEach(n.Kr, (function(r) {
                                                return e.persistence.Co.Ca(t, n.targetId, r);
                                            }));
                                        }));
                                    }));
                                })) ];
                              ...
                              case 4:
                                for (o = 0, s = r; o < s.length; o++) u = s[o], a = u.targetId, u.fromCache || (c = e.Vc.get(a), 
                                h = c.et, f = c.it(h), 
...
function Ys(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(s) {
            switch (s.label) {
              case 0:
                return (i = x(t)).currentUser.isEqual(r) ? [ 3 /*break*/ , 3 ] : (T("SyncEngine", "User change. New user:", r.Zs()), 
                [ 4 /*yield*/ , 
                /**
                ...
                function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        ...
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return e = x(t), i = e.vr, o = e.Dc, [ 4 /*yield*/ , e.persistence.runTransaction("Handle user change", "readonly", (function(t) {
                                    // Swap out the mutation queue, grabbing the pending mutation batches
                                    // before and after.
                                    var n;
                                    return e.vr.qo(t).next((function(s) {
                                        return n = s, i = e.persistence.wc(r), 
                                        // Recreate our LocalDocumentsView using the new
                                        // MutationQueue.
                                        o = new di(e.Sc, i, e.persistence.Ec()), i.qo(t);
                                    })).next((function(e) {
                              ...
                              case 1:
                                return s = n.sent(), [ 2 /*return*/ , (e.vr = i, e.Dc = o, e.yc.Cc(e.Dc), s) ];
                            }
                        }));
                    }));
                }(i.Wu, r) ]);
              ...
              case 1:
                ...
                i.bh.Wi(r, o.jh, o.Kh), [ 4 /*yield*/ , Qs(i, o.Wh) ];
...
function Hs(t, e) {
    var n = x(t), r = n.xh.get(e);
    if (r && r.yh) return Wt().add(r.key);
    var i = Wt(), o = n.Nh.get(e);
    if (!o) return i;
    for (var s = 0, u = o; s < u.length; s++) {
        var a = u[s], c = n.Ch.get(a);
        i = i.xt(c.view.fh);
    }
    return i;
}
 ...
 */ function $s(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return [ 4 /*yield*/ , Po((e = x(t)).Wu, r.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = n.sent(), o = r.view.Ph(i), [ 2 /*return*/ , (e.qh && zs(e, r.targetId, o.Ah), 
                o) ];
            }
        }));
    }));
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.Oo(t, e).next((function(e) {
                            return e ? n.Dc.$r(t, e) : Dr.resolve(null);
                        }));
                    }));
                }((e = x(t)).Wu, r) ];

              case 1:
                return null === (s = n.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , ys(e.Vh) ];
...
function Xs(t, r) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              case 0:
                return iu(e = x(t)), ou(e), !0 !== r || !0 === e.Bh ? [ 3 /*break*/ , 3 ] : (i = e.bh.Di(), 
                [ 4 /*yield*/ , Js(e, i.A()) ]);

              case 1:
                return o = n.sent(), e.Bh = !0, [ 4 /*yield*/ , _s(e.Vh, !0) ];

              case 2:
                for (n.sent(), s = 0, u = o; s < u.length; s++) a = u[s], rs(e.Vh, a);
                return [ 3 /*break*/ , 7 ];

              case 3:
                return !1 !== r || !1 === e.Bh ? [ 3 /*break*/ , 7 ] : (c = [], h = Promise.resolve(), 
                e.Nh.forEach((function(t, n) {
                    e.bh.Bi(n) ? c.push(n) : h = h.then((function() {
                        return Bs(e, n), Uo(e.Wu, n, 
                        /*keepPersistedTargetData=*/ !0);
                    })), is(e.Vh, n);
                })), [ 4 /*yield*/ , h ]);
              ...
              case 5:
                ...
                function(t) {
                    ...
                    e.xh.forEach((function(t, n) {
                        is(e.Vh, n);
                    })), e.kh.Uc(), e.xh = new Map, e.$h = new Rt(M.i);
                }(e), e.Bh = !1, [ 4 /*yield*/ , _s(e.Vh, !1) ];
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                return s < u.length ? (a = u[s], c = void 0, (h = e.Nh.get(a)) && 0 !== h.length ? [ 4 /*yield*/ , Lo(e.Wu, er(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return f < l.length ? (p = l[f], d = e.Ch.get(p), [ 4 /*yield*/ , $s(e, d) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , Co(e.Wu, a) ];

              case 8:
                return y = n.sent(), [ 4 /*yield*/ , Lo(e.Wu, y) ];

              case 9:
                return c = n.sent(), [ 4 /*yield*/ , Rs(e, tu(y), a, 
                /*current=*/ !1) ];
...
function eu(t) {
    var e = x(t);
    return x(x(e.Wu).persistence).Vi();
}
    ...
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(n) {
            switch (n.label) {
              ...
              case 1:
                if (!e.Nh.has(r)) return [ 3 /*break*/ , 8 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 2 ];
              ...
              case 6:
                return n.sent(), Bs(e, r, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function ru(t, r, i) {
    return e(this, void 0, void 0, (function() {
        ...
        return n(this, (function(d) {
            switch (d.label) {
              case 0:
                if (!(e = iu(t)).Bh) return [ 3 /*break*/ , 10 ];
                o = 0, s = r, d.label = 1;

              case 1:
                return o < s.length ? (u = s[o], e.Nh.has(u) ? (
                // A target might have been added in a previous attempt
                T("SyncEngine", "Adding an already active target " + u), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , Co(e.Wu, u) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return a = d.sent(), [ 4 /*yield*/ , Lo(e.Wu, a) ];

              case 3:
                return c = d.sent(), [ 4 /*yield*/ , Rs(e, tu(a), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                d.sent(), rs(e.Vh, c), d.label = 5;
              ...
              case 6:
                h = function(t) {
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e.Nh.has(t) ? [ 4 /*yield*/ , Uo(e.Wu, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                is(e.Vh, t), Bs(e, t);
                            })).catch(qo) ] : [ 3 /*break*/ , 2 ];
...
function iu(t) {
    var e = x(t);
    return e.Vh.Ku.nh = Us.bind(null, e), e.Vh.Ku.Be = Hs.bind(null, e), e.Vh.Ku.eh = Cs.bind(null, e), 
    e.Dh.gu = Qr.bind(null, e.ph), e.Dh.Qh = Yr.bind(null, e.ph), e;
}

function ou(t) {
    var e = x(t);
    return e.Vh.Ku.sh = Ms.bind(null, e), e.Vh.Ku.ih = Fs.bind(null, e), e;
}
 ...
 */ var su = /** @class */ function() {
    ...
    return t.prototype.Cc = function(t) {
        ...
        }(e) || n.isEqual(mt.min()) ? this.zh(t, e) : this.Gh.$r(t, r).next((function(o) {
            var u = i.Hh(e, o);
            return (Hn(e) || $n(e)) && i.Th(e.on, u, r, n) ? i.zh(t, e) : (_() <= s.DEBUG && T("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), ur(e)), 
            i.Gh.Or(t, e, n).next((function(t) {
    ...
    /** Applies the query filter and sorting to the provided documents.  */ t.prototype.Hh = function(t, e) {
        // Sort the documents and re-apply the query filter since previously
        // matching documents do not necessarily still match the query.
        var n = new Pt(cr(t));
        return e.forEach((function(e, r) {
            r instanceof Gn && ar(t, r) && (n = n.add(r));
        })), n;
    }, 
    /**
     ...
     */
    t.prototype.Th = function(t, e, n, r) {
    ...
    function t(t, e) {
        ...
        this.Jh = new Pt(Bo.xc);
    }
    return t.prototype.$o = function(t) {
        return Dr.resolve(0 === this.vr.length);
    }, t.prototype.xo = function(t, e, n, r) {
        var i = this.Yh;
        this.Yh++, this.vr.length > 0 && this.vr[this.vr.length - 1];
        var o = new ci(i, e, n, r);
        this.vr.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.Jh = this.Jh.add(new Bo(a.key, i)), this.Sr.ko(t, a.key.path.h());
        }
        return Dr.resolve(o);
    }, t.prototype.Mo = function(t, e) {
        return Dr.resolve(this.Xh(e));
    }, t.prototype.Lo = function(t, e) {
        var n = e + 1, r = this.Zh(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return Dr.resolve(this.vr.length > i ? this.vr[i] : null);
    }, t.prototype.Bo = function() {
        return Dr.resolve(0 === this.vr.length ? -1 : this.Yh - 1);
    }, t.prototype.qo = function(t) {
        return Dr.resolve(this.vr.slice());
    }, t.prototype.Cr = function(t, e) {
        var n = this, r = new Bo(e, 0), i = new Bo(e, Number.POSITIVE_INFINITY), o = [];
        return this.Jh.Nt([ r, i ], (function(t) {
            var e = n.Xh(t.Wc);
            o.push(e);
        })), Dr.resolve(o);
    }, t.prototype.Mr = function(t, e) {
        var n = this, r = new Pt(st);
        return e.forEach((function(t) {
            var e = new Bo(t, 0), i = new Bo(t, Number.POSITIVE_INFINITY);
            n.Jh.Nt([ e, i ], (function(t) {
                r = r.add(t.Wc);
            }));
        })), Dr.resolve(this.tl(r));
    }, t.prototype.Qr = function(t, e) {
        ...
        // because it precedes all other segments in an ordered traversal.
                M.F(i) || (i = i.child(""));
        var o = new Bo(new M(i), 0), s = new Pt(st);
        // Find unique batchIDs referenced by all documents potentially matching the
        // query.
                return this.Jh.Ft((function(t) {
            var e = t.key.path;
            return !!n.T(e) && (
            ...
            // TODO(mcg): we'll need a different scanner when we implement
            // ancestor queries.
            e.length === r && (s = s.add(t.Wc)), !0);
        }), o), Dr.resolve(this.tl(s));
        ...
        var n = this;
        k(0 === this.el(e.batchId, "removed")), this.vr.shift();
        var r = this.Jh;
        return Dr.forEach(e.mutations, (function(i) {
            var o = new Bo(i.key, e.batchId);
        ...
        var n = new Bo(e, 0), r = this.Jh.$t(n);
        return Dr.resolve(e.isEqual(r && r.key));
    }, t.prototype.Go = function(t) {
        return this.vr.length, Dr.resolve();
    }, 
    /**
    ...
    return t.prototype.Tr = function(t, e, n) {
        var r = e.key, i = this.docs.get(r), o = i ? i.size : 0, s = this.nl(e);
    ...
    t.prototype.Ir = function(t) {
        ...
        ; o.It(); ) {
            ...
            h.L(n) <= 0 || c instanceof Gn && ar(e, c) && (r = r.rt(c.key, c));
        }
        return Dr.resolve(r);
    ...
    return t(n, e), n.prototype.gr = function(t) {
        ...
        return this.dr.forEach((function(r, i) {
            i ? n.push(e.aa.Tr(t, i, e.readTime)) : e.aa.Ir(r);
        })), Dr.$n(n);
    }, n.prototype.Rr = function(t, e) {
        return this.aa.Ar(t, e);
    }, n.prototype.Pr = function(t, e) {
    ...
    function t(t) {
        ...
        /**
             ...
             * IDs.
             */
        this.ol = new jo, this.targetCount = 0, this.al = yo._a();
    }
    return t.prototype.De = function(t, e) {
        return this.il.forEach((function(t, n) {
            return e(n);
        })), Dr.resolve();
    }, t.prototype.Ta = function(t) {
        return Dr.resolve(this.lastRemoteSnapshotVersion);
    }, t.prototype.Ea = function(t) {
        return Dr.resolve(this.rl);
    }, t.prototype.da = function(t) {
        return this.highestTargetId = this.al.next(), Dr.resolve(this.highestTargetId);
    }, t.prototype.Ia = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.al = new yo(e), this.highestTargetId = e), t.sequenceNumber > this.rl && (this.rl = t.sequenceNumber);
    }, t.prototype.Aa = function(t, e) {
        return this.Ra(e), this.targetCount += 1, Dr.resolve();
    }, t.prototype.ga = function(t, e) {
        return this.Ra(e), Dr.resolve();
    }, t.prototype.ya = function(t, e) {
        return this.il.delete(e.target), this.ol.qc(e.targetId), this.targetCount -= 1, 
        Dr.resolve();
    }, t.prototype.Vo = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.il.forEach((function(s, u) {
            u.sequenceNumber <= e && null === n.get(u.targetId) && (r.il.delete(s), o.push(r.Va(t, u.targetId)), 
            i++);
        ...
        var n = this.il.get(e) || null;
        return Dr.resolve(n);
    }, t.prototype.va = function(t, e, n) {
        return this.ol.Oc(e, n), Dr.resolve();
    }, t.prototype.Da = function(t, e, n) {
        this.ol.Bc(e, n);
        ...
        return this.ol.qc(e), Dr.resolve();
    }, t.prototype.Na = function(t, e) {
        var n = this.ol.Qc(e);
        return Dr.resolve(n);
    }, t.prototype.zo = function(t, e) {
        return Dr.resolve(this.ol.zo(e));
    }, t;
}(), fu = /** @class */ function() {
    /**
    ...
    function t(t) {
        var e = this;
        this.cl = {}, this.ka = new Xr(0), this.Ma = !1, this.Ma = !0, this.Co = t(this), 
        this.ja = new hu(this), this.Sr = new Yi, this.br = function(t, n) {
    ...
    return t.prototype.start = function() {
        ...
        return this.Ma = !1, Promise.resolve();
    }, Object.defineProperty(t.prototype, "Ti", {
        get: function() {
            return this.Ma;
        },
        ...
        var e = this.cl[t.Zs()];
        return e || (e = new uu(this.Sr, this.Co), this.cl[t.Zs()] = e), e;
    }, t.prototype.mc = function() {
        return this.ja;
    }, t.prototype.Tc = function() {
        return this.br;
        ...
        var i = new lu(this.ka.next());
        return this.Co.hl(), n(i).next((function(t) {
            return r.Co.ll(i).next((function() {
                return t;
            }));
        })).Nn().then((function(t) {
            return i.pr(), t;
        ...
        return Dr.xn(Object.values(this.cl).map((function(n) {
            return function() {
                return n.zo(t, e);
            };
        })));
    ...
    return t.wl = function(e) {
        ...
        return this.fl.Sa(n, e), this.ml.delete(n.toString()), Dr.resolve();
    }, t.prototype.Ca = function(t, e, n) {
        return this.fl.Ca(n, e), this.ml.add(n.toString()), Dr.resolve();
    }, t.prototype.Ko = function(t, e) {
        return this.ml.add(e.toString()), Dr.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        this.fl.qc(e.targetId).forEach((function(t) {
            return n.ml.add(t.toString());
        }));
        var r = this.persistence.mc();
        return r.Na(t, e.targetId).next((function(t) {
            t.forEach((function(t) {
                return n.ml.add(t.toString());
            }));
        })).next((function() {
        ...
        var e = this, n = this.persistence.Tc().ia();
        // Remove newly orphaned documents.
                return Dr.forEach(this.ml, (function(r) {
            var i = M.D(r);
            return e.Tl(t, i).next((function(t) {
                t || n.Ir(i);
            }));
        })).next((function() {
            return e.dl = null, n.apply(t);
        }));
    }, t.prototype.gc = function(t, e) {
        var n = this;
        return this.Tl(t, e).next((function(t) {
            t ? n.ml.delete(e.toString()) : n.ml.add(e.toString());
        }));
        ...
        var n = this;
        return Dr.xn([ function() {
            return Dr.resolve(n.fl.zo(e));
        }, function() {
            return n.persistence.mc().zo(t, e);
        }, function() {
            return n.persistence._l(t, e);
        } ]);
    }, t;
}(), du = /** @class */ function() {
    function t(t) {
        this.El = t.El, this.Il = t.Il;
    }
     ...
     * HTTP).
     */
    return t(n, e), n.prototype.Cl = function(t, e, n, r) {
        ...
        var n = [ this.bl, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], r = g(), i = {
    ...
    function t(t) {
        this.pl = t, this.U = t.U;
        var e = t.ssl ? "https" : "http";
        this.bl = e + "://" + t.host, this.vl = "projects/" + this.U.projectId + "/databases/" + this.U.database + "/documents";
    }
    return t.prototype.$u = function(t, e, n, r) {
        var i = this.Sl(t, e);
        T("RestConnection", "Sending: ", i, n);
        var o = {};
        return this.Dl(o, r), this.Cl(t, i, o, n).then((function(t) {
            return T("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw A("RestConnection", t + " failed with error: ", e, "url: ", i, "request:", n), 
            e;
        }));
    }, t.prototype.xu = function(t, e, n, r) {
    ...
    t.prototype.Dl = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/7.23.0", 
        // Content-Type: text/plain will avoid preflight requests which might
        // mess with CORS and redirects by proxies. If we add custom headers
        // we will need to change this code to potentially use the $httpOverwrite
        // parameter supported by ESF to avoid triggering preflight requests.
        t["Content-Type"] = "text/plain", e) for (var n in e.jc) e.jc.hasOwnProperty(n) && (t[n] = e.jc[n]);
    }, t.prototype.Sl = function(t, e) {
        var n = vu[t];
    ...
    return t.prototype.Xu = function(t) {
        ...
        window.removeEventListener("online", this.Nl), window.removeEventListener("offline", this.$l);
    }, t.prototype.Ml = function() {
        window.addEventListener("online", this.Nl), window.addEventListener("offline", this.$l);
 ...
 */ var bu = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.", Iu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.bh = this.Ol(t), this.persistence = this.Ll(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.Bl = this.ql(t), this.Wu = this.Ul(t), [ 2 /*return*/ ];
                }
            }));
        }));
        ...
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new su, r = t.Ql, new ko(e, n, r);
        var e, n, r;
    }, t.prototype.Ll = function(t) {
        if (t.persistenceSettings.Wl) throw new I(b.FAILED_PRECONDITION, bu);
        return new fu(pu.wl);
        ...
        return e(this, void 0, void 0, (function() {
            return n(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.Bl && this.Bl.stop(), [ 4 /*yield*/ , this.bh.Si() ];
    ...
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this.jl._i, this.bh instanceof ui ? (this.bh._i = {
                        tr: Zs.bind(null, i),
                        er: nu.bind(null, i),
                        nr: ru.bind(null, i),
                        Vi: eu.bind(null, i)
                  ...
                  case 3:
                    ...
                    return [ 4 /*yield*/ , this.persistence.Ja((function(t) {
                        return e(o, void 0, void 0, (function() {
                            return n(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , Xs(this.jl._i, t) ];

                                  case 1:
                                    return e.sent(), this.Bl && (t && !this.Bl.Ti ? this.Bl.start(this.Wu) : t || this.Bl.stop()), 
                                    [ 2 /*return*/ ];
                                }
                            }));
                        }));
        ...
        if (t.persistenceSettings.Wl && t.persistenceSettings.synchronizeTabs) {
            var e = Mr();
            if (!ui.On(e)) throw new I(b.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            var n = Do(t.pl.U, t.pl.persistenceKey);
            return new ui(e, t.os, n, t.clientId, t.Ql);
        }
        return new ai;
    }, i;
}(/** @class */ function(r) {
    function i(t) {
        var e = this;
        return (e = r.call(this) || this).jl = t, e;
    }
    return t(i, r), i.prototype.initialize = function(t) {
        return e(this, void 0, void 0, (function() {
            return n(this, (function(e) {
                switch (e.label) {
                  ...
                  case 1:
                    return e.sent(), [ 4 /*yield*/ , Fo(this.Wu) ];

                  case 2:
                    return e.sent(), [ 4 /*yield*/ , this.jl.initialize(this, t) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return e.sent(), [ 4 /*yield*/ , ou(this.jl._i) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return e.sent(), [ 4 /*yield*/ , ys(this.jl.Vh) ];
        ...
        return new bi(e, t.os);
    }, i.prototype.Ll = function(t) {
        var e = Do(t.pl.U, t.pl.persistenceKey), n = wu(t.pl.U);
        return new _o(t.persistenceSettings.synchronizeTabs, e, t.clientId, wi.oo(t.persistenceSettings.cacheSizeBytes), t.os, Mr(), Fr(), n, this.bh, t.persistenceSettings.xa);
    }, i.prototype.Ol = function(t) {
        return new ai;
        ...
        return function(t) {
            return e(this, void 0, void 0, (function() {
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return kr.On() ? (e = t + "main", [ 4 /*yield*/ , kr.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
    ...
    return t.prototype.initialize = function(t, r) {
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Wu ? [ 3 /*break*/ , 2 ] : (this.Wu = t.Wu, this.bh = t.bh, this.ju = this.Kl(r), 
                    this.Vh = this.Gl(r), this.ph = this.zl(r), this._i = this.Hl(r), this.bh.fi = function(t) {
                        return Ps(e._i, t, 1 /* SharedClientState */);
                    }, this.Vh.Ku.Yl = Ys.bind(null, this._i), [ 4 /*yield*/ , _s(this.Vh, this._i.qh) ]);
        ...
        var e, n = wu(t.pl.U), r = (e = t.pl, new yu(e));
        /** Return the Platform-specific connectivity monitor. */ return function(t, e, n) {
            return new Zo(t, e, n);
        }(t.credentials, r, n);
    }, t.prototype.Gl = function(t) {
        var e, n, r, i, o, s = this;
        return e = this.Wu, n = this.ju, r = t.os, i = function(t) {
            return Ps(s._i, t, 0 /* RemoteStore */);
        }, o = gu.On() ? new gu : new mu, new Jo(e, n, r, i, o);
        ...
        r, i, o, s) {
            ...
            return s && (u.Bh = !0), u;
        }(this.Wu, this.Vh, this.ph, this.bh, t.Ql, t.Sh, !t.persistenceSettings.Wl || !t.persistenceSettings.synchronizeTabs);
    }, t.prototype.terminate = function() {
        return ns(this.Vh);
    }, t;
}(), Tu = /** @class */ function() {
    ...
    return t.prototype.next = function(t) {
        this.observer.next && this.Jl(this.observer.next, t);
    }, t.prototype.error = function(t) {
        this.observer.error ? this.Jl(this.observer.error, t) : console.error("Uncaught Error in snapshot listener:", t);
    }, t.prototype.Xl = function() {
        this.muted = !0;
    ...
    for (var e = 0; e < t.length; ++e) if (G("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new I(b.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.Zl = new C(t);
}, Au = /** @class */ function(e) {
    /**
...
var Vu = /** @class */ function(e) {
...
}(Du), Lu = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).a_ = n, r;
    }
    return t(n, e), n.prototype.e_ = function(t) {
        var e = new gn(t.serializer, Ve(t.serializer, this.a_));
        return new In(t.path, e);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(Du), Uu = /** @class */ function() {
    /**
     ...
     */
    t.prototype.isEqual = function(t) {
        return this.c_ === t.c_ && this.u_ === t.u_;
    }, t.prototype.toJSON = function() {
        return {
            latitude: this.c_,
            longitude: this.u_
     ...
     */
    t.prototype.H = function(t) {
        return st(this.c_, t.c_) || st(this.u_, t.u_);
    }, t;
}(), Pu = function(t) {
    this.h_ = t;
}, Cu = /^__.*__$/, Mu = function(t, e, n) {
    ...
    return t.prototype.d_ = function(t, e) {
        var n = [];
        return null !== this.Qe ? n.push(new On(t, this.data, this.Qe, e)) : n.push(new Vn(t, this.data, e)), 
...
/** A "context" object passed around while parsing user data. */ var Bu = /** @class */ function() {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.m_ = function(e) {
        ...
        return ta(t, this.settings.methodName, this.settings.R_ || !1, this.path, this.settings.i_);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.E_(this.path.get(t));
    }, t.prototype.E_ = function(t) {
        if (0 === t.length) throw this.s_("Document fields must not be empty");
        if (ju(this.n_) && Cu.test(t)) throw this.s_('Document fields cannot begin and end with "__"');
    }, t;
}(), Gu = /** @class */ function() {
    function t(t, e, n) {
...
/** Parse document data from a set() call. */ function zu(t, e, n, r, i, o) {
    ...
    var u, a, c = Hu(r, s);
    if (o.merge) u = new bn(s.Qe), a = s.fieldTransforms; else if (o.mergeFields) {
        for (var h = [], f = 0, l = o.mergeFields; f < l.length; f++) {
            var p = l[f], d = void 0;
            if (p instanceof Nu) d = p.Zl; else {
    ...
    return new Fu(new Fn(c), u, a);
}

/** Parse update data from an update() call. */ function Wu(t, e, n, r) {
    var i = t.P_(1 /* Update */ , e, n);
    Zu("Data must be an object, but it was:", i, r);
    var o = [], s = new qn;
    O(r, (function(t, r) {
        var u = Ju(e, t, n), a = i.I_(u);
        if (r instanceof ku || r instanceof Pu && r.h_ instanceof ku) 
    ...
    var u = new bn(o);
    return new qu(s.Je(), u, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Ku(t, e, n, r, i, o) {
    var s = t.P_(1 /* Update */ , e, n), u = [ Xu(e, r, n) ], a = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) u.push(Xu(e, o[c])), a.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], f = new qn, l = u.length - 1; l >= 0; --l) if (!ea(h, u[l])) {
        var p = u[l], d = a[l], v = s.I_(p);
        if (d instanceof ku || d instanceof Pu && d.h_ instanceof ku) 
        // Add it to the field mask, but don't add anything to updateData.
        h.push(p); else {
            var y = Yu(d, v);
    ...
    var g = new bn(h);
    return new qu(f.Je(), g, s.fieldTransforms);
}
 ...
 */ function Qu(t, e, n, r) {
    return void 0 === r && (r = !1), Yu(n, t.P_(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function Yu(t, e) {
    ...
    // from firestore-exp.
    t instanceof Pu && (t = t.h_), $u(t)) return Zu("Unsupported field value:", e, t), 
    Hu(t, e);
    if (t instanceof Du) 
    ...
    return function(t, e) {
        ...
        if (!ju(e.n_)) throw e.s_(t.t_ + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if (t instanceof ht) return {
            bytesValue: Re(e.serializer, t.q)
        };
        if (t instanceof Mu) {
            var i = e.U, o = t.l_;
            ...
            return {
                referenceValue: Pe(t.l_ || e.U, t.__.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.s_("Unsupported field value: " + Z(t));
    }(t, e);
}
...
function $u(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof gt || t instanceof Uu || t instanceof ht || t instanceof Mu || t instanceof Du);
}
 ...
 */ function Xu(t, e, n) {
    if (e instanceof Nu) return e.Zl;
 ...
 */ var na = /** @class */ function() {
    function t(t) {
        ...
        this.g_ = new Map, this.mutations = [], this.y_ = !1, 
        /**
    ...
    return t.prototype.b_ = function(t) {
                ...
                switch (o.label) {
                    ...
                    return [ 4 /*yield*/ , function(t, r) {
                        return e(this, void 0, void 0, (function() {
                            ...
                            return n(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return e = x(t), i = Be(e.serializer) + "/documents", o = {
                                        documents: r.map((function(t) {
                                            return Me(e.serializer, t);
                                        }))
                                    }, [ 4 /*yield*/ , e.xu("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = n.sent(), u = new Map, s.forEach((function(t) {
                                        var n = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = Fe(t, e.found.name), r = Ue(e.found.updateTime), i = new Fn({
                                                    mapValue: {
                                                ...
                                                var n = Fe(t, e.missing), r = Ue(e.readTime);
                                                return new zn(n, r);
                                            }(t, e) : D();
                                        }(e.serializer, t);
                  ...
                  case 1:
                    return [ 2 /*return*/ , ((r = o.sent()).forEach((function(t) {
                        t instanceof zn || t instanceof Gn ? i.S_(t) : D();
                    })), r) ];
                }
            }));
        }));
    }, t.prototype.set = function(t, e) {
        this.write(e.d_(t, this.Ke(t))), this.p_.add(t.toString());
        ...
        this.write([ new Cn(t, this.Ke(t)) ]), this.p_.add(t.toString());
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(i) {
                switch (i.label) {
                  case 0:
                    if (this.v_(), this.V_) throw this.V_;
                    return t = this.g_, 
                    ...
                    t.forEach((function(t, e) {
                        var n = M.D(e);
                        r.mutations.push(new Mn(n, r.Ke(n)));
                    ...
                    }(this.ju, this.mutations) ];

                  case 1:
                    // For each mutation, note that the doc was written.
                    return i.sent(), this.y_ = !0, [ 2 /*return*/ ];
                }
            }));
        }));
    }, t.prototype.S_ = function(t) {
    ...
    t.prototype.Ke = function(t) {
        ...
        return !this.p_.has(t.toString()) && e ? _n.updateTime(e) : _n.Ge();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        this.os = t, this.ju = e, this.updateFunction = n, this.hs = r, this.C_ = 5, this.gs = new Sr(this.os, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.gs.Rn((function() {
            return e(t, void 0, void 0, (function() {
                var t, e, r = this;
                return n(this, (function(n) {
                    return t = new na(this.ju), (e = this.F_(t)) && e.then((function(e) {
                        r.os.ds((function() {
        ...
        var e = this;
        this.C_ > 0 && this.k_(t) ? (this.C_ -= 1, this.os.ds((function() {
    ...
    return t.prototype.start = function(t, r, i, o) {
        ...
        return this.credentials.zc((function(t) {
            if (!a) return a = !0, T("FirestoreClient", "Initializing. user=", t.uid), s.L_(r, i, o, t, u).then(s.M_.resolve, s.M_.reject);
            s.os.Ds((function() {
                return function(t, r) {
                    return e(this, void 0, void 0, (function() {
                        var e, i;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return (e = x(t)).os.Fs(), T("RemoteStore", "RemoteStore received new credentials"), 
                                i = cs(e), 
                                // Tear down and re-create our network streams. This will ensure we get a
                                // fresh auth token for the new user and re-fill the write pipeline with
                                // new mutations from the LocalStore (since mutations are per-user).
                                e.Hu.add(3 /* CredentialChange */), [ 4 /*yield*/ , es(e) ];

                              case 1:
                                return n.sent(), i && 
                                // Don't set the network status to Unknown if we are offline.
                                e.Zu.set("Unknown" /* Unknown */), [ 4 /*yield*/ , e.Ku.Yl(r) ];

                              case 2:
                                return n.sent(), e.Hu.delete(3 /* CredentialChange */), [ 4 /*yield*/ , ts(e) ];
    ...
    /** Enables the network connection and requeues all pending operations. */ t.prototype.enableNetwork = function() {
        var t = this;
        return this.O_(), this.os.enqueue((function() {
            return t.persistence.Za(!0), function(t) {
                var e = x(t);
                return e.Hu.delete(0 /* UserDisabled */), ts(e);
            }(t.Vh);
        }));
    }, 
    /**
     ...
     *     succeeded.
     */
    t.prototype.L_ = function(t, r, i, o, s) {
        return e(this, void 0, void 0, (function() {
            var u, a, c = this;
            return n(this, (function(h) {
                switch (h.label) {
                  ...
                  case 2:
                    return h.sent(), this.persistence = t.persistence, this.bh = t.bh, this.Wu = t.Wu, 
                    this.Bl = t.Bl, this.ju = r.ju, this.Vh = r.Vh, this._i = r._i, this.B_ = r.ph, 
                    this.B_.qs = Os.bind(null, this._i), this.B_.Ws = Ls.bind(null, this._i), 
                    // When a user calls clearPersistence() in one client, all other clients
                    // need to be terminated to allow the delete to succeed.
                    this.persistence.Xa((function() {
    ...
    /** Disables the network connection. Pending operations will not complete. */ t.prototype.disableNetwork = function() {
        var t = this;
        return this.O_(), this.os.enqueue((function() {
            return t.persistence.Za(!1), function(t) {
                return e(this, void 0, void 0, (function() {
                    var e;
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return (e = x(t)).Hu.add(0 /* UserDisabled */), [ 4 /*yield*/ , es(e) ];

                          case 1:
                            return n.sent(), 
                            // Set the OnlineState to Offline so get()s return from cache, etc.
                            e.Zu.set("Offline" /* Offline */), [ 2 /*return*/ ];
                        }
                    }));
                }));
            }(t.Vh);
                ...
                return n(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        ...
                        this.Bl && this.Bl.stop(), [ 4 /*yield*/ , ns(this.Vh) ];

                      case 1:
                        return n.sent(), [ 4 /*yield*/ , this.bh.Si() ];
                      ...
                      case 3:
                        ...
                        // auth tokens.
                        this.credentials.Hc(), r.resolve(), [ 3 /*break*/ , 5 ];
    ...
    t.prototype.waitForPendingWrites = function() {
            ...
            return function(t, r) {
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            cs((e = x(t)).Vh) || T("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                            n.label = 1;
                          ...
                          case 2:
                            return -1 === (i = n.sent()) ? [ 2 /*return*/ , void r.resolve() ] : ((o = e.Oh.get(i) || []).push(r), 
                            e.Oh.set(i, o), [ 3 /*break*/ , 4 ]);

                          case 3:
                            return s = n.sent(), u = Br(s, "Initialization of waitForPendingWrites() operation failed"), 
        ...
        return e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return this.O_(), [ 4 /*yield*/ , this.M_.promise ];

                  case 1:
                    return o.sent(), r = new Ar, [ 2 /*return*/ , (this.os.ds((function() {
                            ...
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      ...
                                      case 1:
                                        return (e = n.sent()) instanceof Gn ? i.resolve(e) : e instanceof zn ? i.resolve(null) : i.reject(new I(b.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)")), 
                                        [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return o = n.sent(), s = Br(o, "Failed to get document '" + r + " from cache"), 
        ...
        return void 0 === r && (r = {}), e(this, void 0, void 0, (function() {
            ...
            return n(this, (function(n) {
                switch (n.label) {
                  ...
                  case 1:
                    return n.sent(), e = new Ar, [ 2 /*return*/ , (this.os.ds((function() {
                        ...
                        return function(t, r, i) {
                            return e(this, void 0, void 0, (function() {
                                ...
                                return n(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , Po(t, r, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return e = n.sent(), o = new Ds(r, e.Nc), s = o.dh(e.documents), u = o.gr(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(u.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return a = n.sent(), c = Br(a, "Failed to execute query '" + r + " against cache"), 
                ...
                return e(this, void 0, void 0, (function() {
                    ...
                    return n(this, (function(n) {
                        switch (n.label) {
                                ...
                                return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                                    return r.Dc.$r(t, o).next((function(o) {
                                        ...
                                        var s = [], u = 0, a = e; u < a.length; u++) {
                                            ...
                                            // exists=true
                                            s.push(new On(c.key, h, jn(h.proto.mapValue), _n.exists(!0)));
                                        }
                          ...
                          case 2:
                            return o = n.sent(), e.bh.Fi(o.batchId), function(t, e, n) {
                                var r = t.Mh[t.currentUser.Zs()];
                                r || (r = new Rt(st)), r = r.rt(e, n), t.Mh[t.currentUser.Zs()] = r;
                            }(e, o.batchId, i), [ 4 /*yield*/ , Qs(e, o.dr) ];

                          case 3:
                            return n.sent(), [ 4 /*yield*/ , ys(e.Vh) ];

                          case 4:
                            return n.sent(), [ 3 /*break*/ , 6 ];

                          case 5:
                            return s = n.sent(), u = Br(s, "Failed to persist write"), i.reject(u), [ 3 /*break*/ , 6 ];
    ...
    t.prototype.transaction = function(t) {
        ...
        var n = new Ar;
        return this.os.ds((function() {
            return new ra(e.os, e.ju, t, n).run(), Promise.resolve();
        })), n.promise;
    }, t;
}();
...
var sa = /** @class */ function() {
    function t(t, e, n, r, i) {
        this.U = t, this.timestampsInSnapshots = e, this.z_ = n, this.H_ = r, this.Y_ = i;
    }
    return t.prototype.J_ = function(t) {
        switch (he(t)) {
          ...
          case 6 /* BlobValue */ :
            return this.Y_(we(t.bytesValue));

          case 7 /* RefValue */ :
            return this.tf(t.referenceValue);

          case 8 /* GeoPointValue */ :
            return this.ef(t.geoPointValue);

          case 9 /* ArrayValue */ :
            return this.nf(t.arrayValue);
        ...
        return new Uu(me(t.latitude), me(t.longitude));
        ...
        var e = ge(t), n = new gt(e.seconds, e.nanos);
...
}(), ua = wi.uo, aa = /** @class */ function() {
    function t(t) {
        var e, n, r, i;
        if (void 0 === t.host) {
            if (void 0 !== t.ssl) throw new I(b.INVALID_ARGUMENT, "Can't provide ssl option if host option is not set");
            this.host = "firestore.googleapis.com", this.ssl = !0;
        } else W("settings", "non-empty string", "host", t.host), this.host = t.host, K("settings", "boolean", "ssl", t.ssl), 
        ...
        K("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = wi.lo; else {
            if (t.cacheSizeBytes !== ua && t.cacheSizeBytes < wi.ho) throw new I(b.INVALID_ARGUMENT, "cacheSizeBytes must be at least " + wi.ho);
    ...
    function t(r, i, o, s) {
        var u = this;
        if (void 0 === o && (o = new Iu), void 0 === s && (s = new _u), this.if = o, this.rf = s, 
        this.af = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.cf = new jr, this.INTERNAL = {
            delete: function() {
                return e(u, void 0, void 0, (function() {
                    return n(this, (function(t) {
                        switch (t.label) {
                          case 0:
                            ...
                            // throws an exception.
                            return this.uf(), [ 4 /*yield*/ , this.hf.terminate() ];
            ...
            var a = r;
            this.af = a, this.l_ = t.lf(a), this._f = a.name, this.ff = new Wo(i);
        } else {
            var c = r;
            if (!c.projectId) throw new I(b.INVALID_ARGUMENT, "Must provide projectId");
            this.l_ = new vt(c.projectId, c.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this._f = "[DEFAULT]", this.ff = new zo;
        }
        this.df = new aa({});
    }
    return Object.defineProperty(t.prototype, "wf", {
        get: function() {
            ...
            this.mf = new Gu(this.l_, this.df.ignoreUndefinedProperties)), this.mf;
        },
        enumerable: !1,
        configurable: !0
        ...
        var e = new aa(t);
        if (this.hf && !this.df.isEqual(e)) throw new I(b.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
        ...
        return this.uf(), this.hf.enableNetwork();
    }, t.prototype.disableNetwork = function() {
        return this.uf(), this.hf.disableNetwork();
    }, t.prototype.enablePersistence = function(t) {
        var e, n;
        if (this.hf) throw new I(b.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        var r = !1, i = !1;
        ...
        return this.Tf(this.if, this.rf, {
            Wl: !0,
            cacheSizeBytes: this.df.cacheSizeBytes,
            synchronizeTabs: r,
            xa: i
        });
        ...
        return e(this, void 0, void 0, (function() {
            var t, r = this;
            return n(this, (function(i) {
                if (void 0 !== this.hf && !this.hf.G_) throw new I(b.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
                return t = new Ar, [ 2 /*return*/ , (this.cf.ps((function() {
                    return e(r, void 0, void 0, (function() {
                        var e;
                        return n(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return n.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.if.clearPersistence(this.l_, this._f) ];
    ...
    }, Object.defineProperty(t.prototype, "Ef", {
        get: function() {
            return this.uf(), this.hf.G_;
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.waitForPendingWrites = function() {
        return this.uf(), this.hf.waitForPendingWrites();
    }, t.prototype.onSnapshotsInSync = function(t) {
        if (this.uf(), oa(t)) return this.hf.K_(t);
        ...
        // eslint-disable-next-line @typescript-eslint/no-floating-promises
        this.Tf(new Iu, new _u, {
            Wl: !1
        }), this.hf;
    }, t.prototype.If = function() {
        return new dt(this.l_, this._f, this.df.host, this.df.ssl, this.df.experimentalForceLongPolling);
    }, t.prototype.Tf = function(t, e, n) {
        var r = this.If();
        return this.hf = new ia(this.ff, this.cf), this.hf.start(r, t, e, n);
    }, t.lf = function(t) {
        ...
        get: function() {
            if (!this.af) throw new I(b.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
            return this.af;
        },
        enumerable: !1,
        configurable: !0
 ...
 */
        ...
        this.uf().transaction((function(n) {
            return t(new ha(e, n));
        }));
    }, t.prototype.batch = function() {
        return this.uf(), new fa(this);
    ...
    t.prototype.Rf = function() {
        return this.df.timestampsInSnapshots;
    }, 
    // Visible for testing.
    ...
    return t.prototype.get = function(t) {
        ...
        var n = Da("Transaction.get", t, this.gf);
        return this.yf.b_([ n.__ ]).then((function(t) {
            if (!t || 1 !== t.length) return D();
            var r = t[0];
            if (r instanceof zn) return new da(e.gf, n.__, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.f_);
            if (r instanceof Gn) return new da(e.gf, n.__, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.f_);
            throw D();
        }));
        ...
        var r = Da("Transaction.set", t, this.gf);
        n = Na("Transaction.set", n);
        var i = xa(r.f_, e, n), o = zu(this.gf.wf, "Transaction.set", r.__, i, null !== r.f_, n);
        return this.yf.set(r.__, o), this;
        ...
        r = Da("Transaction.update", t, this.gf), i = Ku(this.gf.wf, "Transaction.update", r.__, e, n, o)) : (q("Transaction.update", arguments, 2), 
        r = Da("Transaction.update", t, this.gf), i = Wu(this.gf.wf, "Transaction.update", r.__, e)), 
        this.yf.update(r.__, i), this;
    }, t.prototype.delete = function(t) {
        q("Transaction.delete", arguments, 1);
        var e = Da("Transaction.delete", t, this.gf);
        return this.yf.delete(e.__), this;
    }, t;
}(), fa = /** @class */ function() {
    function t(t) {
        this.gf = t, this.Vf = [], this.pf = !1;
    }
    return t.prototype.set = function(t, e, n) {
        B("WriteBatch.set", arguments, 2, 3), this.bf();
        var r = Da("WriteBatch.set", t, this.gf);
        n = Na("WriteBatch.set", n);
        var i = xa(r.f_, e, n), o = zu(this.gf.wf, "WriteBatch.set", r.__, i, null !== r.f_, n);
        return this.Vf = this.Vf.concat(o.d_(r.__, _n.Ge())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r, i, o = [], s = 3; s < arguments.length; s++) o[s - 3] = arguments[s];
        return this.bf(), "string" == typeof e || e instanceof Au ? (j("WriteBatch.update", arguments, 3), 
        r = Da("WriteBatch.update", t, this.gf), i = Ku(this.gf.wf, "WriteBatch.update", r.__, e, n, o)) : (q("WriteBatch.update", arguments, 2), 
        r = Da("WriteBatch.update", t, this.gf), i = Wu(this.gf.wf, "WriteBatch.update", r.__, e)), 
        this.Vf = this.Vf.concat(i.d_(r.__, _n.exists(!0))), this;
    }, t.prototype.delete = function(t) {
        q("WriteBatch.delete", arguments, 1), this.bf();
        var e = Da("WriteBatch.delete", t, this.gf);
        return this.Vf = this.Vf.concat(new Cn(e.__, _n.Ge())), this;
    }, t.prototype.commit = function() {
        return this.bf(), this.pf = !0, this.Vf.length > 0 ? this.gf.uf().write(this.Vf) : Promise.resolve();
    }, t.prototype.bf = function() {
        if (this.pf) throw new I(b.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }, t;
}(), la = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this, n.l_, t, r) || this).__ = t, i.firestore = n, i.f_ = r, 
        i.hf = i.firestore.uf(), i;
    }
    return t(n, e), n.Af = function(t, e, r) {
        ...
        get: function() {
            return this.__.path._();
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(n.prototype, "parent", {
        get: function() {
            return new Ta(this.__.path.h(), this.firestore, this.f_);
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(n.prototype, "path", {
        get: function() {
            return this.__.path.R();
        },
        enumerable: !1,
        configurable: !0
        ...
        var e = U.P(t);
        return new Ta(this.__.path.child(e), this.firestore, 
        /* converter= */ null);
    }, n.prototype.isEqual = function(t) {
        if (!(t instanceof n)) throw tt("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.__.isEqual(t.__) && this.f_ === t.f_;
    }, n.prototype.set = function(t, e) {
        B("DocumentReference.set", arguments, 1, 2), e = Na("DocumentReference.set", e);
        var n = xa(this.f_, t, e), r = zu(this.firestore.wf, "DocumentReference.set", this.__, n, null !== this.f_, e);
        return this.hf.write(r.d_(this.__, _n.Ge()));
    }, n.prototype.update = function(t, e) {
        for (var n, r = [], i = 2; i < arguments.length; i++) r[i - 2] = arguments[i];
        return "string" == typeof t || t instanceof Au ? (j("DocumentReference.update", arguments, 2), 
        n = Ku(this.firestore.wf, "DocumentReference.update", this.__, t, e, r)) : (q("DocumentReference.update", arguments, 1), 
        n = Wu(this.firestore.wf, "DocumentReference.update", this.__, t)), this.hf.write(n.d_(this.__, _n.exists(!0)));
    }, n.prototype.delete = function() {
        return q("DocumentReference.delete", arguments, 0), this.hf.write([ new Cn(this.__, _n.Ge()) ]);
        ...
        "object" != typeof i[u] || oa(i[u]) || (J("DocumentReference.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        } else G("DocumentReference.onSnapshot", "function", u, i[u]), z("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        ...
        return this.hf.listen(Yn(this.__.path), a, h);
    }, n.prototype.get = function(t) {
        var e = this;
        B("DocumentReference.get", arguments, 0, 1), Sa("DocumentReference.get", t);
        var n = this.firestore.uf();
        return t && "cache" === t.source ? n.U_(this.__).then((function(t) {
            return new da(e.firestore, e.__, t, 
            /*fromCache=*/ !0, t instanceof Gn && t.Ye, e.f_);
        })) : n.Q_(this.__, t).then((function(t) {
            return e.vf(t);
        }));
    ...
    n.prototype.vf = function(t) {
        ...
        return new da(this.firestore, this.__, e, t.fromCache, t.hasPendingWrites, this.f_);
    }, n;
}(Mu), pa = /** @class */ function() {
    function t(t, e) {
    ...
    function t(t, e, n, r, i, o) {
        this.gf = t, this.__ = e, this.Sf = n, this.Df = r, this.Cf = i, this.f_ = o;
    }
    return t.prototype.data = function(t) {
        var e = this;
        if (B("DocumentSnapshot.data", arguments, 0, 1), t = Aa("DocumentSnapshot.data", t), 
        this.Sf) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.f_) {
                var n = new va(this.gf, this.__, this.Sf, this.Df, this.Cf, 
                /* converter= */ null);
                return this.f_.fromFirestore(n, t);
            }
            return new sa(this.gf.l_, this.gf.Rf(), t.serverTimestamps || "none", (function(t) {
                return new la(t, e.gf, /* converter= */ null);
            }), (function(t) {
                return new pt(t);
            })).J_(this.Sf.sn());
        }
        ...
        var n = this;
        if (B("DocumentSnapshot.get", arguments, 1, 2), e = Aa("DocumentSnapshot.get", e), 
        this.Sf) {
            var r = this.Sf.data().field(Xu("DocumentSnapshot.get", t, this.__));
            if (null !== r) return new sa(this.gf.l_, this.gf.Rf(), e.serverTimestamps || "none", (function(t) {
                return new la(t, n.gf, n.f_);
            }), (function(t) {
                return new pt(t);
            })).J_(r);
        }
        ...
        get: function() {
            return new la(this.__, this.gf, this.f_);
        },
        enumerable: !1,
        configurable: !0
        ...
        get: function() {
            return new pa(this.Cf, this.Df);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw tt("isEqual", "DocumentSnapshot", 1, e);
        return this.gf === e.gf && this.Df === e.Df && this.__.isEqual(e.__) && (null === this.Sf ? null === e.Sf : this.Sf.isEqual(e.Sf)) && this.f_ === e.f_;
    }, t;
}(), va = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
...
function ma(t, e, n) {
    if ("string" == typeof n) {
        ...
        if (!Jn(e) && -1 !== n.indexOf("/")) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(U.P(n));
    ...
    if (n instanceof Mu) return be(t, n.__);
...
function Ia(t) {
    if ($n(t) && 0 === t.rn.length) throw new I(b.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}

var Ea = /** @class */ function() {
    function t(t, e, n) {
        this.Nf = t, this.firestore = e, this.f_ = n;
    }
    return t.prototype.where = function(e, n, r) {
        q("Query.where", arguments, 3), X("Query.where", 3, r);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        var i = Y("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , "!=" /* NOT_EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ , "not-in" /* NOT_IN */ ], 2, n), o = Xu("Query.where", e), s = ya(this.Nf, "Query.where", this.firestore.wf, this.firestore.l_, o, i, r);
        return new t(function(t, e) {
            var n = t.filters.concat([ e ]);
            return new Kn(t.path, t.collectionGroup, t.rn.slice(), n, t.limit, t.on, t.startAt, t.endAt);
        }(this.Nf, s), this.firestore, this.f_);
        ...
        var i = Xu("Query.orderBy", e), o = ga(this.Nf, i, r);
        return new t(function(t, e) {
            // TODO(dimond): validate that orderBy does not list the same key twice.
            var n = t.rn.concat([ e ]);
            return new Kn(t.path, t.collectionGroup, n, t.filters.slice(), t.limit, t.on, t.startAt, t.endAt);
        }(this.Nf, o), this.firestore, this.f_);
    }, t.prototype.limit = function(e) {
        return q("Query.limit", arguments, 1), G("Query.limit", "number", 1, e), et("Query.limit", 1, e), 
        new t(nr(this.Nf, e, "F" /* First */), this.firestore, this.f_);
    }, t.prototype.limitToLast = function(e) {
        return q("Query.limitToLast", arguments, 1), G("Query.limitToLast", "number", 1, e), 
        et("Query.limitToLast", 1, e), new t(nr(this.Nf, e, "L" /* Last */), this.firestore, this.f_);
    }, t.prototype.startAt = function(e) {
        for (var n = [], r = 1; r < arguments.length; r++) n[r - 1] = arguments[r];
        j("Query.startAt", arguments, 1);
        var i = this.Ff("Query.startAt", e, n, 
        /*before=*/ !0);
        return new t(rr(this.Nf, i), this.firestore, this.f_);
        ...
        /*before=*/ !0);
        return new t(ir(this.Nf, i), this.firestore, this.f_);
        ...
        return this.firestore === e.firestore && or(this.Nf, e.Nf) && this.f_ === e.f_;
    }, t.prototype.withConverter = function(e) {
        return new t(this.Nf, this.firestore, e);
    }, 
    /** Helper function to create a bound from a document or fields */ t.prototype.Ff = function(t, e, n, i) {
        if (X(t, 1, e), e instanceof da) return q(t, r([ e ], n), 1), function(t, e, n, r, i) {
            ...
            return new wr(o, i);
        }(this.Nf, this.firestore.l_, t, e.Sf, i);
        var o = [ e ].concat(n);
        return function(t, e, n, r, i, o) {
            ...
            for (var u = [], a = 0; a < i.length; a++) {
                ...
                if (s[a].field.p()) {
                    ...
                    if (!Jn(t) && -1 !== c.indexOf("/")) throw new I(b.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                    var h = t.path.child(U.P(c));
            ...
            return new wr(u, o);
        }(this.Nf, this.firestore.l_, this.firestore.wf, t, o, i);
    }, t.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        B("Query.onSnapshot", arguments, 1, 4);
        var s = {}, u = 0;
        if ("object" != typeof i[u] || oa(i[u]) || (J("Query.onSnapshot", s = i[u], [ "includeMetadataChanges" ]), 
        ...
        } else G("Query.onSnapshot", "function", u, i[u]), z("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        z("Query.onSnapshot", "function", u + 2, i[u + 2]);
        var c = {
            next: function(t) {
                i[u] && i[u](new _a(r.firestore, r.Nf, t, r.f_));
            },
            error: i[u + 1],
            complete: i[u + 2]
        };
        return Ia(this.Nf), this.firestore.uf().listen(this.Nf, s, c);
    }, t.prototype.get = function(t) {
        var e = this;
        B("Query.get", arguments, 0, 1), Sa("Query.get", t), Ia(this.Nf);
        var n = this.firestore.uf();
        return (t && "cache" === t.source ? n.W_(this.Nf) : n.j_(this.Nf, t)).then((function(t) {
            return new _a(e.firestore, e.Nf, t, e.f_);
        }));
    }, t;
}(), _a = /** @class */ function() {
    function t(t, e, n, r) {
        this.gf = t, this.$f = e, this.xf = n, this.f_ = r, this.kf = null, this.Mf = null, 
    ...
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        B("QuerySnapshot.forEach", arguments, 1, 2), G("QuerySnapshot.forEach", "function", 1, t), 
        this.xf.docs.forEach((function(r) {
            t.call(e, n.Of(r, n.metadata.fromCache, n.xf.Qt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new Ea(this.$f, this.gf, this.f_);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.docChanges = function(t) {
        t && (J("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), K("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        var e = !(!t || !t.includeMetadataChanges);
        if (e && this.xf.jt) throw new I(b.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
        return this.kf && this.Mf === e || (this.kf = 
        /**
     ...
     */
        ...
        }(this.xf, e, this.Of.bind(this)), this.Mf = e), this.kf;
    }, 
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        ...
        return this.gf === e.gf && or(this.$f, e.$f) && this.xf.isEqual(e.xf) && this.f_ === e.f_;
    }, t.prototype.Of = function(t, e, n) {
        return new va(this.gf, t.key, t, e, n, this.f_);
    }, t;
}(), Ta = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        if ((i = e.call(this, Yn(t), n, r) || this).Lf = t, t.length % 2 != 1) throw new I(b.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t.R() + " has " + t.length);
        return i;
    }
    return t(n, e), Object.defineProperty(n.prototype, "id", {
        get: function() {
            return this.Nf.path._();
        },
        enumerable: !1,
        configurable: !0
    }), Object.defineProperty(n.prototype, "parent", {
        get: function() {
            var t = this.Nf.path.h();
            return t.m() ? null : new la(new M(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        // 'undefined' and 'null'.
        0 === arguments.length && (t = ot.k()), G("CollectionReference.doc", "non-empty string", 1, t);
        var e = U.P(t);
        return la.Af(this.Nf.path.child(e), this.firestore, this.f_);
        ...
        // Call set() with the converted value directly to avoid calling toFirestore() a second time.
                return new la(n.__, this.firestore, null).set(e).then((function() {
            return n;
        }));
    }, n.prototype.withConverter = function(t) {
        return new n(this.Lf, this.firestore, t);
    }, n;
}(Ea);
...
function Na(t, e) {
    ...
    if (J(t, e, [ "merge", "mergeFields" ]), K(t, "boolean", "merge", e.merge), function(t, e, n, r, i) {
        void 0 !== r && function(t, e, n, r, i) {
...
function Aa(t, e) {
    return void 0 === e ? {} : (J(t, e, [ "serverTimestamps" ]), Q(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function Sa(t, e) {
    z(t, "object", 1, e), e && (J(t, e, [ "source" ]), Q(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
 ...
 */
        function() {
            ...
            // update() since we'd need the Firestore instance to do this.
                        return j("arrayUnion()", arguments, 1), new Ou("arrayUnion", t);
        }.apply(void 0, t);
        ...
        var r = function() {
            ...
            // NOTE: We don't actually parse the data until it's used in set() or
            // update() since we'd need the Firestore instance to do this.
                        return j("arrayRemove()", arguments, 1), new Ru("arrayRemove", t);
        }.apply(void 0, t);
        return r.t_ = "FieldValue.arrayRemove", new n(r);
    }, n.increment = function(t) {
        G("FieldValue.increment", "number", 1, t), q("FieldValue.increment", arguments, 1);
        var e = function(t) {
            return new Lu("increment", t);
        }(t);
...
function Ra(t) {
    !function(t, e) {
        ...
        }), "PUBLIC" /* PUBLIC */).setServiceProps(Object.assign({}, Oa)));
    }(t), t.registerVersion("@firebase/firestore", "1.17.3");
}

Ra(i);

export { Ra as __PRIVATE_registerFirestore };
